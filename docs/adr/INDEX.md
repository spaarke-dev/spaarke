...
| [ADR-049](ADR-049-compose-shadow-document.md) | Compose save/edit fidelity — render from the model **and** preserve untouched blocks (base re-projection + document-order pairing + verbatim clone); defined-outcome and preserve-untouched are a paired MUST |
