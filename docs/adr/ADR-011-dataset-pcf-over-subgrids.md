...
- [ADR-011 Concise](../../.claude/adr/ADR-011-dataset-pcf.md) - ~100 lines, decision + constraints
- [PCF Constraints](../../.claude/constraints/pcf.md) - MUST/MUST NOT rules for PCF development
- [PCF Control Pattern](../../.claude/patterns/pcf/control-initialization.md) - Dataset PCF code examples

**When to load this full ADR**: Implementation phases, performance targets, technical stack
