...
- [ADR-006 Concise](../../.claude/adr/ADR-006-pcf-over-webresources.md) - ~75 lines, decision + constraints
- [PCF Constraints](../../.claude/constraints/pcf.md) - MUST/MUST NOT rules for PCF development
- [PCF Control Pattern](../../.claude/patterns/pcf/control-initialization.md) - PCF code examples

**When to load this full ADR**: Exception approval process, allowed webresource list
