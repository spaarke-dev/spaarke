...
- [ADR-010 Concise](../../.claude/adr/ADR-010-di-minimalism.md) - ~95 lines, decision + constraints + patterns
- [API Constraints](../../.claude/constraints/api.md) - MUST/MUST NOT rules for API development
- [Service Registration Pattern](../../.claude/patterns/api/service-registration.md) - DI registration code examples

**When to load this full ADR**: DI architecture decisions, seam justification
