...
*For technical implementation details, see the [AI Architecture Guide](../architecture/AI-ARCHITECTURE.md) and [Playbook Architecture](../architecture/playbook-architecture.md).*
