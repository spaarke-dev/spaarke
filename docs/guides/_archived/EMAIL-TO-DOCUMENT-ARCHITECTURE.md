...
> **DEPRECATED**: This document has been superseded by **[sdap-document-processing-architecture.md](../architecture/sdap-document-processing-architecture.md)**, which consolidates all three document processing routes (File Upload, Email-to-Document, Office Add-in) into a single authoritative reference.
>
> **Reason for Deprecation**: Content consolidated to eliminate duplication and provide a single source of truth.
>
> **Version**: 1.2 (Deprecated: January 30, 2026)
> **Date**: January 17, 2026
> **Project**: Email-to-Document Automation (Phase 2) + RAG Pipeline R1
> **Status**: Deprecated - See consolidated architecture document
