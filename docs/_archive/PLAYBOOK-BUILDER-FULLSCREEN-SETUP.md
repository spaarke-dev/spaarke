...
> **ARCHIVED**: March 2026 — This guide documents the old PCF-based Playbook Builder deployment (custom page + PCF control wrapper). The builder is now a React Code Page (`sprk_playbookbuilder.html`). See `docs/guides/SCOPE-CONFIGURATION-GUIDE.md` for current documentation.
