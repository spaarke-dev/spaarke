...
> **DEPRECATED**: This document has been superseded by **[sdap-document-processing-architecture.md](./sdap-document-processing-architecture.md)**, which consolidates all three document processing routes (File Upload, Email-to-Document, Office Add-in) into a single authoritative reference.
>
> **Reason for Deprecation**: Content consolidated to eliminate duplication and provide a single source of truth.
>
> **Last Updated**: January 28, 2026 (Deprecated: January 30, 2026)
