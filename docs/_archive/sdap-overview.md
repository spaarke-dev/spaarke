...
> **DEPRECATED**: This document has been superseded by **[sdap-document-processing-architecture.md](./sdap-document-processing-architecture.md)**, which provides comprehensive coverage of all SDAP+AI document processing routes.
>
> **Reason for Deprecation**: Content outdated and consolidated into the new authoritative reference.
>
> **Source**: SDAP-ARCHITECTURE-GUIDE.md (3000 lines) → Condensed overview
> **Last Updated**: December 30, 2025 (Deprecated: January 30, 2026)
