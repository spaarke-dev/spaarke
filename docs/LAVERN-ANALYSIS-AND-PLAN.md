...
The Insight Engine's existing Fact / Observation / Inference design (per `projects/ai-spaarke-insight-engine-r1/design.md`) has no layer **above** Observations for cross-matter patterns that accumulate evidence and get promoted to durable, citable rules. Precedent Board adds that layer:
