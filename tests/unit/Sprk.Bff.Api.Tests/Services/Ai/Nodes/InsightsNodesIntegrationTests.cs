...
public sealed class InsightsNodesIntegrationTests
{
    ...
    public async Task MiniPlaybook_InsufficientEvidence_EmitsStructuredDecline()
    {
        ...
        {
            Id = "fact:matter:M-1234:matterType",
            ...
            Evidence = new[] { new EvidenceRef { RefType = "fact-source", Ref = "dataverse://sprk_matter/M-1234#matterType" } },
        ...
        resolverMock.Setup(r => r.ResolveAsync("matter:M-1234", "matterType", It.IsAny<string>(), It.IsAny<CancellationToken>()))
        ...
        var liveFactCtx = InsightsNodeTestHelpers.CreateContext(
            ActionType.LiveFact,
            """{ "subject": "matter:M-1234", "predicate": "matterType" }""",
        ...
        out Mock<IOpenAiClient> openAiMock)
    {
        ...
        {
            new LiveFactNode(resolverMock.Object, NullLogger<LiveFactNode>.Instance),
