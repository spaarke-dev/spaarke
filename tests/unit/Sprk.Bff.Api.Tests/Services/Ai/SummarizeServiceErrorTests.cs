...
/// </summary>
public class SummarizeServiceErrorTests
{
    ...
    public SummarizeServiceErrorTests()
    {
    ...
    private void SetupSuccessfulTextExtraction(SummarizeRequest request, string fileName = "test.txt")
    {
    ...
    [Fact]
    public async Task SummarizeStreamAsync_OpenAiRateLimitError_YieldsRateLimitErrorChunk()
    {
        // Arrange
    ...
    [Fact]
    public async Task SummarizeStreamAsync_OpenAiAuthError_YieldsAuthErrorChunk()
    {
        // Arrange
        var request = CreateRequest();
        SetupSuccessfulTextExtraction(request);
    ...
    [Fact]
    public async Task SummarizeStreamAsync_OpenAiContentFilter_YieldsContentFilterErrorChunk()
    {
        // Arrange
        var request = CreateRequest();
        SetupSuccessfulTextExtraction(request);
    ...
    [Fact]
    public async Task SummarizeStreamAsync_OpenAiTimeout_YieldsTimeoutErrorChunk()
    {
        // Arrange
        var request = CreateRequest();
        SetupSuccessfulTextExtraction(request);
    ...
    [Fact]
    public async Task SummarizeAsync_OpenAiRateLimitError_ThrowsSummarizationException()
    {
        // Arrange
        var request = CreateRequest();
        SetupSuccessfulTextExtraction(request);
        ...
        // Act
        var act = () => _service.SummarizeAsync(request);
    ...
    [Fact]
    public async Task SummarizeAsync_OpenAiContentFilter_ThrowsSummarizationException()
    {
        // Arrange
        var request = CreateRequest();
        SetupSuccessfulTextExtraction(request);
    ...
    [Fact]
    public async Task SummarizeAsync_OpenAiTimeout_ThrowsSummarizationException()
    {
        // Arrange
        var request = CreateRequest();
        SetupSuccessfulTextExtraction(request);
    ...
    [Fact]
    public async Task SummarizeAsync_OpenAiAuthError_ThrowsSummarizationException()
    {
        // Arrange
        var request = CreateRequest();
        SetupSuccessfulTextExtraction(request);
