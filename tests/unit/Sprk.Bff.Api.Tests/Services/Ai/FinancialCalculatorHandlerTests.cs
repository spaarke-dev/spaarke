...
public sealed class FinancialCalculatorHandlerTests
{
    ...
    public FinancialCalculatorHandlerTests()
    {
        ...
        _handler = new FinancialCalculatorHandler(_openAiClientMock.Object, _textChunkingServiceMock.Object, Options.Create(new ModelSelectorOptions()), _loggerMock.Object);
    }
