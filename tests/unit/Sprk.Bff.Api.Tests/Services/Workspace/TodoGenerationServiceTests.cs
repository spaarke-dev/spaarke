...
public class TodoGenerationServiceTests
{
    ...
    public async Task TodoExistsAsync_WhenExactTitleExists_ReturnsTrue()
    {
        ...
        _dataverseMock
            .Setup(d => d.QueryEventsAsync(
                null, null, null, null, null, null, null, 0, 100, It.IsAny<Guid?>(), It.IsAny<CancellationToken>()))
    ...
    public async Task RunGenerationPass_WhenTodoAlreadyExists_SkipsCreation()
    {
        ...
        _dataverseMock
            .Setup(d => d.QueryEventsAsync(
                null, null, null, null, null, null, It.Is<DateTime?>(dt => dt != null), 0, 100, It.IsAny<Guid?>(), It.IsAny<CancellationToken>()))
            .ReturnsAsync((new[] { overdueEvent }, 1));

        // Rule 3: deadline proximity — empty
        _dataverseMock
            .Setup(d => d.QueryEventsAsync(
                null, null, null, null, null, It.Is<DateTime?>(dt => dt != null), It.Is<DateTime?>(dt => dt != null), 0, 100, It.IsAny<Guid?>(), It.IsAny<CancellationToken>()))
            .ReturnsAsync((Array.Empty<EventEntity>(), 0));
