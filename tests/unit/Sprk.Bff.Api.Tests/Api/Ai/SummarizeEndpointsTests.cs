...
/// </summary>
public class SummarizeEndpointsTests : IClassFixture<CustomWebAppFactory>
{
    private readonly HttpClient _client;

    public SummarizeEndpointsTests(CustomWebAppFactory factory)
    {
    ...
    public async Task StreamSummarize_EndpointExists_AcceptsPost()
    {
        ...
        var response = await _client.PostAsJsonAsync("/api/ai/summarize/stream", request);
