...
- **Seed data**: [`golden-utterances.json`](golden-utterances.json) — 55 cases across 20 families, each traceable to a §3 UC trigger in [`SPAARKE-AI-ARCHITECTURE-AND-COMPONENT-DESIGN.md`](../../../../docs/architecture/SPAARKE-AI-ARCHITECTURE-AND-COMPONENT-DESIGN.md)
