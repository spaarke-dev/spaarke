...
(function () {
    ...
    var w = window;
    w.Spaarke = w.Spaarke || {};
    w.Spaarke.CommunicationsGrid = w.Spaarke.CommunicationsGrid || {};
    var ns = w.Spaarke.CommunicationsGrid;
    // ===========================================================================
    // CONFIGURATION
    // ===========================================================================
     ...
     */
    function buildDataEnvelope(regardingAttribute, regardingValue) {
        return ('regardingAttribute=' +
    ...
    ns.onLoad = function (executionContext) {
        try {
            ...
            var recordIdRaw = formContext.data.entity.getId();
            if (!recordIdRaw) {
            ...
            var regardingField = REGARDING_FIELD_MAP[entityName.toLowerCase()];
            if (!regardingField) {
                ...
                // eslint-disable-next-line no-console
                console.warn('[Communications Grid] v' +
                    ns._version +
                    " onLoad: entity '" +
                    entityName +
            ...
            var control = formContext.getControl(ns._controlName);
            if (!control) {
                // eslint-disable-next-line no-console
                console.warn('[Communications Grid] v' +
                    ns._version +
            ...
            var recordId = stripBraces(recordIdRaw);
            var dataEnvelope = buildDataEnvelope(regardingField, recordId);
            ...
            // eslint-disable-next-line no-console
            console.log('[Communications Grid] v' +
                ns._version +
                ' onLoad: scoped to ' +
                entityName +
                ' ' +
