...
public static class CosmosModule
{
        ...
        IConfiguration configuration)
    {
        ...
        //
        // Serializer: camelCase — every POCO in Models/ carries explicit
        // [JsonPropertyName] so the naming policy is defensive rather than
        // load-bearing, but keeps ad-hoc types (e.g. query projections in
        // future waves) shaped consistently with the wire schema.
        //
