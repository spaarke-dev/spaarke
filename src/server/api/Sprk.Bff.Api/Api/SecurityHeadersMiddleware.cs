...
public sealed class SecurityHeadersMiddleware
{
    ...
    public async Task Invoke(HttpContext ctx)
    {
        ...
        // The former /playbook-builder frame-ancestors carve-out was removed 2026-07-08:
        // the BFF no longer hosts a SPA — PlaybookBuilder ships as the sprk_playbookbuilder
        // Dataverse web resource (Deploy-PlaybookBuilder.ps1).
