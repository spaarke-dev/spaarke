...
public static class OfficeModule
{
    ...
    public static IServiceCollection AddOfficeModule(this IServiceCollection services)
    {
        ...
        // FR-13 (spaarkeai-word-add-in-r1 task 030): shared server-side creation service — Matter numbering
        // (uniqueness-probed), load-bearing owner, BU defaults, Field Mapping Framework. Concrete (ADR-010: one
