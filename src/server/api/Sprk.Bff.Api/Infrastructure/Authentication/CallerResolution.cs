...
/// problem. Same class of hazard, same mitigation, as
/// <see cref="TenantResolution"/> for <c>tid</c>.
/// </para>
/// <para>
...
/// <i>cannot</i> read an identity out of a header, route value or body — the same structural guarantee
/// <see cref="TenantResolution"/> makes.
/// </para>
/// </remarks>
