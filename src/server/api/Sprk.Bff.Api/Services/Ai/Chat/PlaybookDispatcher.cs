...
public sealed class PlaybookDispatcher
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        // ADR-015 tier-1 telemetry: counts + latency only. No query content, file content,
        // embedding values, or classifier confidence leaves the process via the log pipeline.
        ...
        _logger.LogInformation(
            ...
            "perFileLatencyMs=[{PerFileLatencyMs}] " +
