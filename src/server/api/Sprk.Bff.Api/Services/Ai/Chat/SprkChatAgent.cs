...
///
/// FR-P2-06 (task 035): the Phase-2F compound-intent pre-inspection member and its
/// raw-client dependency were DELETED with the classifier stack — the agent-turn loop
/// is the ONE dispatch protocol (ADR-039); side effects gate at the dispatch seam.
/// </summary>
