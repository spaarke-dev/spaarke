...
public static class ChatSseEventFactory
{
    ...
    // FR-P2-06 (task 035): the FR-49 options-event factory method was DELETED with the
    // dispatcher stack — nothing builds or consumes that SSE projection anymore (ADR-039).
