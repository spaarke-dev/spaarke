...
public interface IPlaybookService
{
    ...
    // FR-P2-06 (task 035): the FR-13 drift-scan enumerator (ListAllActivePlaybooksAsync)
    // and index-state writer (UpdateIndexStatusAsync) were DELETED with the
    // playbook-embeddings index jobs — their only callers.
}
