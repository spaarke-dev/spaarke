...
public sealed class AiAnalysisNodeExecutor : INodeExecutor
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            // Convert to tool execution context (includes merged reference + document context knowledge)
            var toolContext = CreateToolExecutionContext(context, mergedRagKnowledge);
