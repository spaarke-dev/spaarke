/**
 * Theme Provider Utility for SPE Admin App Code Page
 *
 ...
 *
 * Based on src/solutions/LegalWorkspace/src/providers/ThemeProvider.ts
 * Adapted for SPE Admin App context.
 */
