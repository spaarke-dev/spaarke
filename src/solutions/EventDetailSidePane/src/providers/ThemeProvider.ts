/**
 * Theme Provider Utility for EventDetailSidePane Custom Page
 *
 ...
 *
 * Based on src/client/pcf/EventCalendarFilter/control/providers/ThemeProvider.ts
 * Adapted for Custom Page context (no PCF context available).
 */
