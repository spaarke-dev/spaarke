...
// messaging-communication-app-r2 — task 040 (FR-11)
// Mirrors the sprk_invoicespage Vite config (canonical "simple shell" DataGrid Code Page pattern).
// @spaarke/ui-components is resolved from its prebuilt dist/ via node_modules — same
// resolution path the other DataGrid consumers use (per ADR-026 reference list).
