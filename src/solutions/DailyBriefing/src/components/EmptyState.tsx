/**
 * EmptyState — re-export shim.
 *
 * The canonical `EmptyState` was hoisted to the new shared package
 ...
 * `src/client/shared/Spaarke.DailyBriefing.Components/src/components/EmptyState.tsx`.
 */
