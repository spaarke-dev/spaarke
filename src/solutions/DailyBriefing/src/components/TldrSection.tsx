/**
 * TldrSection — re-export shim.
 *
 * The canonical `TldrSection` was hoisted to the new shared package
 ...
 * `src/client/shared/Spaarke.DailyBriefing.Components/src/components/TldrSection.tsx`.
 */
