/**
 * PreferencesDropdown — re-export shim.
 *
 * The canonical `PreferencesDropdown` was hoisted to the new shared package
 ...
 * `src/client/shared/Spaarke.DailyBriefing.Components/src/components/PreferencesDropdown.tsx`.
 */

export {
  PreferencesDropdown,
  type PreferencesDropdownProps,
