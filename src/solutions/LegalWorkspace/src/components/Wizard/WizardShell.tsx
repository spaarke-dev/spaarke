 ...
 * WizardShell.tsx
 *
 * Generic, domain-free wizard dialog shell extracted from WizardDialog.tsx.
 *
 * Layout:
 *   +------------------------------------------------------+
 *   | Title bar                              [X Close]      |
...
import { WizardStepper } from '../CreateMatter/WizardStepper';
...
// ---------------------------------------------------------------------------
// Styles (extracted from WizardDialog.tsx — generic shell layout only)
// ---------------------------------------------------------------------------
