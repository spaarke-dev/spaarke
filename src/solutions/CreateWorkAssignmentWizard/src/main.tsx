/**
 * Create Work Assignment Wizard - Code Page Entry Point
 *
 * Thin wrapper that mounts the WorkAssignmentWizardDialog component inside a
 ...
 * Web resource name: sprk_createworkassignmentwizard
 *
