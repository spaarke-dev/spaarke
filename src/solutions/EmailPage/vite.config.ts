 ...
 *
 * Required because @spaarke/auth, @spaarke/ui-components, and
 * @spaarke/communication-components are aliased to source directories outside
 * the project root. Their bare imports (e.g., "@fluentui/react-components")
 * must be resolved from this project's node_modules. Mirrors
 * src/solutions/DailyBriefing/vite.config.ts exactly.
 */
...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      "@spaarke/communication-components": path.resolve(
        __dirname,
        "../../client/shared/Spaarke.Communication.Components/src"
      ),
    ...
    dedupe: ["react", "react-dom", "scheduler", "@fluentui/react-components", "@fluentui/react-icons"],
  },
  build: {
    // Handle CJS modules from shared library dependencies
    commonjsOptions: {
