  ...
  React.useEffect(() => {
    ...
    void (async () => {
      try {
        ...
        // (WorkspacePane, ManageWorkspacesPane, usePlaybookOptions, main.tsx). Reading only globalThis.Xrm
        // returned undefined here → the BU container never resolved → a false "no storage container
        // configured" save error even when the BU has one (UAT 2026-08-18).
