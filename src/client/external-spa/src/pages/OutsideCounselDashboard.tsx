/**
 * OutsideCounselDashboard — the R1 outside-counsel data dashboard (Recent Activity,
 * Upcoming, My Projects, My Matters, My Documents).
 *
 * Extracted (via `git mv`) from the former `WorkspaceHomePage.tsx` in task 011 when
 * that file became the module-host shell host. Preserved intact (R1 parity, no
 * regression); task 016 re-homes these sections as entitlement-gated workspace
 * WIDGETS on the new shell (design.md §12). Not currently routed — mounted by the
 * widget registry in task 012/016.
 *
...
export const OutsideCounselDashboard: React.FC = () => {
  const styles = useStyles();
...
export default OutsideCounselDashboard;
