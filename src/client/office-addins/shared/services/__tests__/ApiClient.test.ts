...
describe("ApiClient", () => {
  ...
  describe("get", () => {
    ...
    it("should handle error response with ProblemDetails", async () => {
      ...
      try {
        ...
        expect((error as ApiClientError).error.correlationId).toBe(
          "correlation-123",
        );
      }
    });
  ...
  describe("uploadFile", () => {
    ...
    it("should throw when not authenticated", async () => {
      ...
      await expect(
        apiClient.uploadFile("/api/upload", mockFile, "test.txt"),
    ...
    it("should handle upload error", async () => {
      ...
      await expect(
        apiClient.uploadFile("/api/upload", mockFile, "test.exe"),
