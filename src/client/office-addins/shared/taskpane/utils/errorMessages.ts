...
const ERROR_CODE_MAP: Record<string, ErrorMessage> = {
  ...
  OFFICE_001: {
    ...
    message:
      "The source type is not recognized. Please try again or contact support.",
    type: "error",
    recoverable: false,
  },
  OFFICE_002: {
    ...
    message:
      "The selected entity type is not supported for document association.",
    type: "error",
    recoverable: false,
  },
  ...
  OFFICE_004: {
    ...
    message:
      "The attachment exceeds the 25MB size limit. Please reduce the file size or upload it separately.",
    type: "error",
    recoverable: true,
  ...
  OFFICE_005: {
    ...
    message:
      "The combined size of all attachments exceeds 100MB. Please select fewer attachments.",
    type: "error",
    recoverable: true,
  ...
  OFFICE_006: {
    ...
    message:
      "This file type is not allowed for security reasons. Executable files cannot be saved.",
    type: "error",
    recoverable: false,
  },
  ...
  OFFICE_007: {
    ...
    message:
      "The selected entity could not be found. It may have been deleted or you may not have access.",
    type: "error",
    recoverable: true,
  ...
  OFFICE_008: {
    title: "Job Not Found",
    message:
      "The processing job could not be found. It may have expired or been deleted.",
    type: "error",
    recoverable: false,
  },
  ...
  OFFICE_010: {
    ...
    message:
      "You do not have permission to create new entities. Please contact your administrator.",
    type: "error",
    recoverable: false,
  },
  ...
  OFFICE_013: {
    title: "Service Error",
    message:
      "A service error occurred while processing your request. Please try again later.",
    type: "error",
    recoverable: true,
    action: "Wait a moment and try again.",
  },
 ...
 * ```
 */
export function mapProblemDetailsToMessage(
