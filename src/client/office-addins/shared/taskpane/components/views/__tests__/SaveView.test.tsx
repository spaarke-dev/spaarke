...
describe("SaveView", () => {
  ...
  describe("email with attachments", () => {
    ...
    it("renders include attachments checkbox", () => {
      ...
      expect(
        screen.getByRole("checkbox", { name: /include attachments/i }),
      ).toBeInTheDocument();
    });
  ...
  describe("save action", () => {
    it("calls onSave with correct options", async () => {
      ...
      renderWithProvider(
        <SaveView hostContext={mockEmailContext} onSave={handleSave} />,
      );
  ...
  describe("saving state", () => {
    ...
    it("shows progress bar when saving", () => {
      renderWithProvider(
        <SaveView hostContext={mockEmailContext} isSaving progress={50} />,
      );
    ...
    it("updates progress bar value", () => {
      renderWithProvider(
        <SaveView hostContext={mockEmailContext} isSaving progress={75} />,
      );
  ...
  describe("edge cases", () => {
    ...
    it("handles email with undefined attachments", () => {
      ...
      renderWithProvider(
        <SaveView hostContext={contextWithUndefinedAttachments} />,
      );
