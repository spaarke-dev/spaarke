...
describe("ShareView", () => {
  ...
  describe("document selection", () => {
    it("selects document when clicked", async () => {
      ...
      // Select document
      const docResult = screen
        .getByText("Important Contract.docx")
        .closest("div");
      ...
      await waitFor(() => {
        ...
        expect(
          screen.getByText(/Selected: Important Contract.docx/),
        ).toBeInTheDocument();
      });
    });
    ...
    it("clears generated link when new document is selected", async () => {
      const handleSearch = jest.fn().mockResolvedValue(mockSearchResults);
      const handleGenerateLink = jest
        .fn()
        .mockResolvedValue("https://share.spaarke.com/abc123");
      ...
      await waitFor(() => {
        expect(
          screen.getByDisplayValue("https://share.spaarke.com/abc123"),
        ).toBeInTheDocument();
      });
      ...
      await waitFor(() => {
        expect(
          screen.queryByDisplayValue("https://share.spaarke.com/abc123"),
  ...
  describe("link generation", () => {
    ...
    it("allows changing permission type before generating", async () => {
      ...
      const handleGenerateLink = jest
        .fn()
        .mockResolvedValue("https://share.spaarke.com/edit123");
    ...
    it("displays generated link", async () => {
      ...
      const handleGenerateLink = jest
        .fn()
        .mockResolvedValue("https://share.spaarke.com/xyz789");
      ...
      await waitFor(() => {
        expect(
          screen.getByDisplayValue("https://share.spaarke.com/xyz789"),
        ).toBeInTheDocument();
      });
    });
  });
  ...
  describe("copy link", () => {
    it("copies link to clipboard", async () => {
      ...
      const handleGenerateLink = jest
        .fn()
        .mockResolvedValue("https://share.spaarke.com/copy123");
      ...
      expect(mockClipboard.writeText).toHaveBeenCalledWith(
        "https://share.spaarke.com/copy123",
      );
    });
    ...
    it('shows "Copied!" feedback after copying', async () => {
      ...
      const handleGenerateLink = jest
        .fn()
        .mockResolvedValue("https://share.spaarke.com/feedback");
  ...
  describe("insert link", () => {
    it("calls onInsertLink with generated link", async () => {
      ...
      const handleGenerateLink = jest
        .fn()
        .mockResolvedValue("https://share.spaarke.com/insert123");
      ...
      expect(handleInsertLink).toHaveBeenCalledWith(
        "https://share.spaarke.com/insert123",
      );
    });
    ...
    it("only shows insert button when link is generated", async () => {
      ...
      expect(
        screen.queryByRole("button", { name: /insert link/i }),
      ).not.toBeInTheDocument();
    });
  });
