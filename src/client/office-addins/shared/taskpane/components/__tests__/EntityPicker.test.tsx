...
describe("EntityPicker", () => {
  ...
  describe("initial render", () => {
    it("renders with default placeholder", () => {
      ...
      expect(
        screen.getByPlaceholderText("Search for an association target..."),
      ).toBeInTheDocument();
    });
    ...
    it("does not render filter chips when showTypeFilter is false", () => {
      ...
      expect(
        screen.queryByRole("checkbox", { name: /Matter/i }),
  ...
  describe("selected state", () => {
    ...
    it("calls onChange with null when clear button is clicked", async () => {
      ...
      renderWithProvider(
        <EntityPicker value={mockEntity} onChange={handleChange} />,
      );
  ...
  describe("search behavior", () => {
    it("updates query when typing", async () => {
      ...
      const input = screen.getByPlaceholderText(
        "Search for an association target...",
      );
  ...
  describe("type filter", () => {
    ...
    it("only shows allowed types", () => {
      renderWithProvider(
        <EntityPicker showTypeFilter allowedTypes={["Matter", "Project"]} />,
      );
  ...
  describe("error handling", () => {
    it("displays error message", () => {
      renderWithProvider(
        <EntityPicker errorMessage="Please select an entity" />,
      );
