/**
 * Logger utility for DrillThroughWorkspace PCF
...
const LOG_PREFIX = '[DrillThroughWorkspace]';

// Enable debug logs in development
const isDebugEnabled = process.env.NODE_ENV === 'development' || window.location.search.includes('debug=true');
