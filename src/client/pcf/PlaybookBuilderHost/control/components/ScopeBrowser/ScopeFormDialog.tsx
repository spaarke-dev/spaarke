          ...
          <DialogContent className={styles.content}>
            ...
            {isSystemScope && mode !== "view" && (
              <MessageBar intent="info" className={styles.readOnlyBanner}>
                <MessageBarBody>
                  System scopes are read-only. Use &quot;Save As&quot; to create
                  an editable copy.
                </MessageBarBody>
              </MessageBar>
            )}
            ...
            <Field
              ...
              validationState={
                validationErrors.displayName ? "error" : undefined
              }
            >
              <Input
            ...
            {scopeType === "actions" && (
              <>
                ...
                <Field
                  ...
                  validationState={
                    validationErrors.systemPrompt ? "error" : undefined
                  }
                >
                  <Textarea
                    value={formData.systemPrompt || ""}
                    onChange={(_, data) =>
                      updateField("systemPrompt", data.value)
                    }
                    disabled={isReadOnly}
            ...
            {scopeType === "skills" && (
              <>
                ...
                <Field
                  ...
                  validationState={
                    validationErrors.promptFragment ? "error" : undefined
                  }
                >
                  <Textarea
                    value={formData.promptFragment || ""}
                    onChange={(_, data) =>
                      updateField("promptFragment", data.value)
                    }
                    disabled={isReadOnly}
              ...
              <>
                ...
                <Field className={styles.field} label="Handler Class">
                  <Input
                    ...
                    onChange={(_, data) =>
                      updateField("handlerClass", data.value)
                    }
                    disabled={isReadOnly}
                ...
                <Field className={styles.field} label="Configuration (JSON)">
                  <Textarea
                    ...
                    onChange={(_, data) =>
                      updateField("configuration", data.value)
                    }
                    disabled={isReadOnly}
              ...
              <>
                ...
                {formData.knowledgeType === "inline" && (
                  <Field
                    ...
                    validationState={
                      validationErrors.content ? "error" : undefined
                    }
                  >
                    <Textarea
                ...
                {formData.knowledgeType === "document" && (
                  <Field className={styles.field} label="Document ID">
                    <Input
                      ...
                      onChange={(_, data) =>
                        updateField("documentId", data.value)
                      }
                      disabled={isReadOnly}
