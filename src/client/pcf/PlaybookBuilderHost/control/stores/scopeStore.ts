/**
 * Scope Store - Skills, Knowledge, and Tools selection
 *
 * Zustand store for managing available scope items.
...
const mockSkills: SkillItem[] = [
  ...
  },
  {
    ...
    description: 'Identify key phrases and topics',
    category: 'extraction',
  },
  {
    id: 'skill-3',
...
const mockKnowledge: KnowledgeItem[] = [
  ...
  },
  {
    id: 'knowledge-5',
    name: 'Instructions',
    description: 'Custom inline instructions',
    type: 'inline',
  },
];
...
const mockTools: ToolItem[] = [
  {
    ...
    handlerType: 'DocumentAnalyzer',
  },
  {
    id: 'tool-2',
    name: 'Search Index',
    description: 'Azure AI Search integration',
    handlerType: 'SearchIndex',
  },
  {
    id: 'tool-3',
    name: 'GPT-4 Completion',
    description: 'Azure OpenAI GPT-4 completion',
    handlerType: 'GptCompletion',
  },
  {
    id: 'tool-4',
    name: 'Word Generator',
    description: 'Generate Word documents',
    handlerType: 'WordGenerator',
  },
  {
    id: 'tool-5',
    name: 'PDF Generator',
    description: 'Generate PDF documents',
    handlerType: 'PdfGenerator',
  },
];
...
export const useScopeStore = create<ScopeState>(() => ({
  ...
  getCapabilities: (nodeType: PlaybookNodeType) => {
    return (
      actionTypeCapabilities[nodeType] || {
        allowsSkills: false,
