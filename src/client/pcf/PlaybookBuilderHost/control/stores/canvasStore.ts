...
interface CanvasState {
  ...
  // Aliases for PCF integration
  loadCanvas: (json: string) => void;
...
export const useCanvasStore = create<CanvasState>((set, get) => ({
  ...
  // Aliases for PCF integration (same functionality, cleaner API)
  loadCanvas: (json: string) => get().loadFromJson(json),
  getCanvasJson: () => get().toJson(),
  clearDirty: () => get().markSaved(),
