      ...
      <DialogSurface>
        <DialogBody>
          ...
          <DialogContent className={styles.content}>
            <p>You are about to discard your changes to "{documentName}" and release the document lock.</p>

            <div className={styles.warningRow}>
              <Warning24Regular className={styles.warningIcon} />
              <span className={styles.warningText}>
                Any unsaved changes will be permanently lost. This action cannot be undone.
              </span>
            </div>
          </DialogContent>
