...
import { makeStyles, shorthands, tokens, Tooltip, Text } from '@fluentui/react-components';
...
export const CheckoutStatusBadge: React.FC<CheckoutStatusBadgeProps> = ({ checkoutStatus, isDarkTheme = false }) => {
