...
describe('eventTypeColors utilities', () => {
  describe('getEventTypeColor', () => {
    describe('yellow color mappings', () => {
      it.each(['Hearing', 'hearing', 'Court Hearing', 'Court', 'court', 'Trial', 'trial date'])(
    ...
    describe('blue color mappings', () => {
      it.each(['Meeting', 'meeting', 'Team Meeting', 'Conference', 'conference call', 'Call', 'phone call'])(
        'returns "blue" for "%s"',
        typeName => {
    ...
    describe('teal color mappings', () => {
      it.each(['Project', 'project milestone', 'Milestone', 'key milestone'])('returns "teal" for "%s"', typeName => {
  ...
  describe('getEventTypeBackgroundColor', () => {
    ...
    it('is a convenience wrapper for getEventTypeColorConfig().background', () => {
      ...
      types.forEach(type => {
        expect(getEventTypeBackgroundColor(type)).toBe(getEventTypeColorConfig(type).background);
      });
    });
  });
