...
describe('EventListItem', () => {
  describe('basic rendering', () => {
    ...
    it('renders description when provided', () => {
      renderWithProvider(<EventListItem {...defaultProps} description="Important regulatory filing due" />);
  ...
  describe('overdue state', () => {
    it('displays overdue badge for overdue events', () => {
      renderWithProvider(<EventListItem {...defaultProps} daysUntilDue={3} isOverdue={true} />);
  ...
  describe('click handling', () => {
    it('calls onClick with id and eventType when clicked', () => {
      ...
      renderWithProvider(<EventListItem {...defaultProps} onClick={handleClick} />);
  ...
  describe('navigating/loading state', () => {
    it('shows spinner when isNavigating is true', () => {
      renderWithProvider(<EventListItem {...defaultProps} isNavigating={true} />);
    ...
    it('prevents click when navigating', () => {
      ...
      renderWithProvider(<EventListItem {...defaultProps} onClick={handleClick} isNavigating={true} />);
  ...
  describe('event type color', () => {
    it('accepts custom eventTypeColor prop', () => {
      renderWithProvider(<EventListItem {...defaultProps} eventTypeColor="purple" />);
    ...
    it('uses auto-detected color when not provided', () => {
      renderWithProvider(<EventListItem {...defaultProps} eventTypeName="Hearing" />);
  ...
  describe('structure and composition', () => {
    ...
    it('renders with correct element hierarchy', () => {
      const { container } = renderWithProvider(<EventListItem {...defaultProps} />);
  ...
  describe('edge cases', () => {
    it('handles very long event names', () => {
      ...
      renderWithProvider(<EventListItem {...defaultProps} name={longName} />);
    ...
    it('handles very long descriptions', () => {
      ...
      renderWithProvider(<EventListItem {...defaultProps} description={longDesc} />);
    ...
    it("handles today's date", () => {
      ...
      renderWithProvider(<EventListItem {...defaultProps} dueDate={today} daysUntilDue={0} />);
    ...
    it('handles empty event type name', () => {
      renderWithProvider(<EventListItem {...defaultProps} eventTypeName="" />);
