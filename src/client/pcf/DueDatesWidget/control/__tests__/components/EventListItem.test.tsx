...
describe("EventListItem", () => {
  describe("basic rendering", () => {
    ...
    it("renders description when provided", () => {
      ...
      expect(
        screen.getByText("Important regulatory filing due"),
      ).toBeInTheDocument();
    });
    ...
    it("does not render description when not provided", () => {
      ...
      expect(
        screen.queryByText("Important regulatory filing due"),
  ...
  describe("overdue state", () => {
    it("displays overdue badge for overdue events", () => {
      renderWithProvider(
        <EventListItem {...defaultProps} daysUntilDue={3} isOverdue={true} />,
      );
  ...
  describe("navigating/loading state", () => {
    ...
    it("does not show spinner by default", () => {
      ...
      expect(
        screen.queryByLabelText("Opening event..."),
      ).not.toBeInTheDocument();
    });
  ...
  describe("event type color", () => {
    ...
    it("uses auto-detected color when not provided", () => {
      renderWithProvider(
        <EventListItem {...defaultProps} eventTypeName="Hearing" />,
      );
  ...
  describe("edge cases", () => {
    ...
    it("handles today's date", () => {
      ...
      renderWithProvider(
        <EventListItem {...defaultProps} dueDate={today} daysUntilDue={0} />,
      );
