...
export const EventListItem: React.FC<IEventListItemProps> = ({
  ...
  const containerClasses = mergeClasses(styles.container, isNavigating && styles.containerNavigating);
  ...
  return (
    ...
    >
      ...
      <div className={styles.badgeSection}>
        ...
        {isNavigating && <Spinner size="tiny" className={styles.loadingSpinner} aria-label="Opening event..." />}
      </div>
    </div>
  );
};
