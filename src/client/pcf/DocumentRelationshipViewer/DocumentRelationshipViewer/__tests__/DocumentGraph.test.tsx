...
jest.mock("react-flow-renderer", () => ({
  ...
  useNodesState: jest.fn((initial: unknown[]) => [
    initial,
    jest.fn(),
    jest.fn(),
  ]),
  useEdgesState: jest.fn((initial: unknown[]) => [
    initial,
    jest.fn(),
    jest.fn(),
  ]),
...
const mockUseForceLayout = useForceLayout as jest.MockedFunction<
  typeof useForceLayout
>;
...
describe("DocumentGraph", () => {
  ...
  describe("Empty State", () => {
    it("renders empty state message when no nodes provided", () => {
      ...
      expect(
        screen.getByText("No document relationships to display"),
      ).toBeInTheDocument();
      expect(
  ...
  describe("Loading State", () => {
    ...
    it("hides loading spinner when simulation completes", () => {
      ...
      expect(
        screen.queryByText("Calculating layout..."),
  ...
  describe("Nodes and Edges Updates", () => {
    ...
    it("calls useForceLayout with updated edges", () => {
      ...
      const newEdges = [
        ...sampleEdges,
        createTestEdge("related-1", "related-2"),
      ];
