    ...
    <div className={styles.card}>
      <Skeleton>
        ...
        <div className={styles.header}>
          <SkeletonItem shape="square" className={styles.icon} />
          <div className={styles.titleGroup}>
            <SkeletonItem shape="rectangle" className={styles.title} />
            <SkeletonItem shape="rectangle" className={styles.subtitle} />
          </div>
          <SkeletonItem shape="rectangle" className={styles.badge} />
        </div>
        ...
        <div className={styles.metadata}>
          <SkeletonItem shape="rectangle" className={styles.metaItem} />
          <SkeletonItem shape="rectangle" className={styles.metaItem} />
          <SkeletonItem shape="rectangle" className={styles.metaItem} />
        </div>
      </Skeleton>
