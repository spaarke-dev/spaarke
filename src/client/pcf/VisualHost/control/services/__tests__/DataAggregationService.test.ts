 ...
 */
function createMockDefinition(overrides?: Partial<IChartDefinition>): IChartDefinition {
  return {
...
describe('DataAggregationService', () => {
  ...
  describe('fetchRecords', () => {
    ...
    it('should throw AggregationError on fetch failure', async () => {
      ...
      await expect(fetchRecords(mockContext, 'sprk_project')).rejects.toThrow(AggregationError);
    });
  });
  ...
  describe('aggregateRecords', () => {
    describe('Count aggregation', () => {
      ...
      it('should count records by group', () => {
        ...
        const result = aggregateRecords(records, AggregationType.Count, undefined, 'statuscode');
    ...
    describe('Sum aggregation', () => {
      ...
      it('should sum field values by group', () => {
        ...
        const result = aggregateRecords(records, AggregationType.Sum, 'amount', 'statuscode');
    ...
    describe('Average aggregation', () => {
      it('should average field values', () => {
        ...
        const result = aggregateRecords(records, AggregationType.Average, 'amount');
    ...
    describe('Edge cases', () => {
      ...
      it('should handle boolean group values', () => {
        const records = [{ isActive: true }, { isActive: true }, { isActive: false }];

        const result = aggregateRecords(records, AggregationType.Count, undefined, 'isActive');
      ...
      it('should handle missing aggregation field', () => {
        ...
        const result = aggregateRecords(records, AggregationType.Sum, 'nonexistent_field');
      ...
      it('should handle non-numeric values for numeric aggregations', () => {
        const records = [{ amount: 'not a number' }, { amount: 'also not' }, { amount: 100 }];
  ...
  describe('fetchAndAggregate', () => {
    ...
    it('should throw error when entity name is missing', async () => {
      ...
      await expect(fetchAndAggregate(mockContext, definition)).rejects.toThrow(AggregationError);
    });
  ...
  describe('aggregateData', () => {
    it('should aggregate pre-loaded data', () => {
      ...
      const result = aggregateData(records, AggregationType.Count, undefined, 'statuscode');
    ...
    it('should return correct chart data structure', () => {
      ...
      const result = aggregateData(records, AggregationType.Sum, 'amount', 'statuscode');
