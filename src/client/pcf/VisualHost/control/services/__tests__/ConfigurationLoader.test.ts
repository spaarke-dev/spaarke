 ...
 */
function createMockRecord(overrides?: Partial<Record<string, unknown>>): Record<string, unknown> {
  return {
...
describe('ConfigurationLoader', () => {
  ...
  describe('loadChartDefinition', () => {
    ...
    it('should normalize GUID format (remove braces)', async () => {
      ...
      await loadChartDefinition(mockContext, '{12345678-1234-1234-1234-123456789012}');
    ...
    it('should bypass cache when skipCache is true', async () => {
      ...
      await loadChartDefinition(mockContext, '12345678-1234-1234-1234-123456789012', true);
    ...
    it('should throw ConfigurationNotFoundError when record not found', async () => {
      ...
      await expect(loadChartDefinition(mockContext, '12345678-1234-1234-1234-999999999999')).rejects.toThrow(
        ConfigurationNotFoundError
      );
    });
    ...
    it('should throw ConfigurationLoadError for other errors', async () => {
      ...
      await expect(loadChartDefinition(mockContext, '12345678-1234-1234-1234-123456789012')).rejects.toThrow(
        ConfigurationLoadError
      );
    });
    ...
    it('should throw ConfigurationLoadError when ID is empty', async () => {
      ...
      await expect(loadChartDefinition(mockContext, '')).rejects.toThrow(ConfigurationLoadError);
    });
  ...
  describe('loadChartDefinitions', () => {
    it('should load multiple chart definitions', async () => {
      ...
      const mockContext = createMockContext({
        retrieveRecord: jest.fn().mockResolvedValueOnce(mockRecord1).mockResolvedValueOnce(mockRecord2),
      });
  ...
  describe('queryChartDefinitions', () => {
    it('should query chart definitions with filter', async () => {
      ...
      const results = await queryChartDefinitions(mockContext, 'sprk_visualtype eq 100000001');
  ...
  describe('clearCache', () => {
    ...
    it('should clear entire cache when no ID provided', async () => {
      ...
      // Load two records
      await loadChartDefinition(mockContext, '12345678-1234-1234-1234-123456789012');
      await loadChartDefinition(mockContext, '22222222-2222-2222-2222-222222222222');
