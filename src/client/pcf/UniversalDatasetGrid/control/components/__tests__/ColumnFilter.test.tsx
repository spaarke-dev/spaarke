...
describe('ColumnFilter', () => {
  ...
  describe('rendering for filterable columns', () => {
    ...
    filterableDataTypes.forEach(dataType => {
      it(`renders filter button for ${dataType} column`, () => {
        ...
        renderWithProvider(<ColumnFilter column={column} filterValue={null} onFilterChange={onFilterChange} />);

        const filterButton = screen.getByRole('button', {
          name: /filter test column/i,
        });
  ...
  describe('rendering for non-filterable columns', () => {
    it('returns null for Image column', () => {
      ...
      const { container } = renderWithProvider(
        <ColumnFilter column={column} filterValue={null} onFilterChange={onFilterChange} />
      );
  ...
  describe('filter state indication', () => {
    it('shows regular filter icon when no filter active', () => {
      ...
      renderWithProvider(<ColumnFilter column={column} filterValue={null} onFilterChange={jest.fn()} />);
    ...
    it('shows filled filter icon when filter is active', () => {
      ...
      renderWithProvider(<ColumnFilter column={column} filterValue={filterValue} onFilterChange={jest.fn()} />);
  ...
  describe('choice options extraction', () => {
    it('extracts unique choice options from dataset records', () => {
      ...
      renderWithProvider(
        <ColumnFilter column={column} filterValue={null} onFilterChange={jest.fn()} dataset={mockDataset} />
      );
