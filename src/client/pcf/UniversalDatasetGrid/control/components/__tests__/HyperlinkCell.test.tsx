...
describe("HyperlinkCell", () => {
  ...
  describe("click handling", () => {
    ...
    it("calls onSidePaneOpened callback on success", async () => {
      ...
      renderWithProvider(
        <HyperlinkCell {...defaultProps} onSidePaneOpened={onSidePaneOpened} />,
      );
      ...
      await waitFor(() => {
        expect(onSidePaneOpened).toHaveBeenCalledWith(
    ...
    it("handles exception in openEventDetailPane", async () => {
      (openEventDetailPane as jest.Mock).mockRejectedValueOnce(
