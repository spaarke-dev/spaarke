...
describe('HyperlinkCell', () => {
  ...
  describe('rendering', () => {
    it('renders link with display text', () => {
      ...
      const link = screen.getByRole('button', {
        name: /open details for test event/i,
      });
  ...
  describe('empty text handling', () => {
    it('renders dash for empty displayText', () => {
      renderWithProvider(<HyperlinkCell {...defaultProps} displayText="" />);
  ...
  describe('disabled state', () => {
    it('renders as plain text when disabled', () => {
      renderWithProvider(<HyperlinkCell {...defaultProps} disabled={true} />);
  ...
  describe('click handling', () => {
    ...
    it('passes eventType to side pane', async () => {
      renderWithProvider(<HyperlinkCell {...defaultProps} eventType="87654321-4321-4321-4321-210987654321" />);
    ...
    it('calls onSidePaneOpened callback on success', async () => {
      ...
      renderWithProvider(<HyperlinkCell {...defaultProps} onSidePaneOpened={onSidePaneOpened} />);
