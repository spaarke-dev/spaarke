# Pack UniversalDatasetGrid Solution
...
try {
    ...
    @('solution.xml', 'customizations.xml', '[Content_Types].xml') | ForEach-Object {
        ...
        # Use -LiteralPath for files with special characters like brackets
    ...
    $controlsDir = Join-Path $PSScriptRoot 'Controls\sprk_Spaarke.UI.Components.UniversalDatasetGrid'
