...
$files = @(
  ...
  @{ Source = "Controls/sprk_Spaarke.Controls.CommunicationActions/ControlManifest.xml"; Entry = "Controls/sprk_Spaarke.Controls.CommunicationActions/ControlManifest.xml" },
  @{ Source = "Controls/sprk_Spaarke.Controls.CommunicationActions/bundle.js"; Entry = "Controls/sprk_Spaarke.Controls.CommunicationActions/bundle.js" },
  @{ Source = "Controls/sprk_Spaarke.Controls.CommunicationActions/styles.css"; Entry = "Controls/sprk_Spaarke.Controls.CommunicationActions/styles.css" }
)
