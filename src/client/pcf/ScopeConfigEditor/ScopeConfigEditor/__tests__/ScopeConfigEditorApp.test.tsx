...
describe('ScopeConfigEditorApp — entity routing', () => {
  ...
  it('renders SkillEditor for sprk_analysisskill entity', () => {
    renderWithProvider(<ScopeConfigEditorApp {...makeDefaultProps('sprk_analysisskill')} />);
  ...
  it('renders SkillEditor injection preview section', () => {
    renderWithProvider(
      <ScopeConfigEditorApp {...makeDefaultProps('sprk_analysisskill')} fieldValue="Use context documents" />
    );
  ...
  it('renders KnowledgeSourceEditor for sprk_analysisknowledge entity', () => {
    renderWithProvider(<ScopeConfigEditorApp {...makeDefaultProps('sprk_analysisknowledge')} />);
  ...
  it('renders ToolEditor for sprk_analysistool entity', async () => {
    renderWithProvider(<ScopeConfigEditorApp {...makeDefaultProps('sprk_analysistool')} />);
    ...
    await waitFor(() => {
      const fallbackOrDropdown =
        screen.queryByTestId('handler-dropdown') || screen.queryByTestId('handler-fallback-input');
  ...
  it('renders unknown entity warning for empty entity name', () => {
    renderWithProvider(<ScopeConfigEditorApp {...makeDefaultProps('')} />);
