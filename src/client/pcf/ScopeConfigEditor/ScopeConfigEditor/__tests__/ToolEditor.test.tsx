...
describe('ToolEditor — JSON validation', () => {
  ...
  it('renders without errors for empty value', () => {
    renderWithProvider(<ToolEditor value="" apiBaseUrl="https://test.api.com" onChange={jest.fn()} />);
  ...
  it('shows no validation error for valid JSON object', () => {
    ...
    renderWithProvider(<ToolEditor value={validJson} apiBaseUrl="https://test.api.com" onChange={jest.fn()} />);
    expect(screen.queryByTestId('json-error-message')).not.toBeInTheDocument();
  });
  ...
  it('shows error message for invalid JSON string', () => {
    ...
    renderWithProvider(<ToolEditor value={invalidJson} apiBaseUrl="https://test.api.com" onChange={jest.fn()} />);
  ...
  it('shows error for JSON array (valid JSON but common mistake)', () => {
    ...
    renderWithProvider(<ToolEditor value={jsonArray} apiBaseUrl="https://test.api.com" onChange={jest.fn()} />);
    expect(screen.queryByTestId('json-error-message')).not.toBeInTheDocument();
  });
...
describe('ToolEditor — handler dropdown', () => {
  ...
  it('renders handler dropdown when API succeeds', async () => {
    mockFetch.mockReturnValue(
      makeHandlersResponse([
        {
          handlerClass: 'DocumentSearchToolHandler',
          displayName: 'Document Search',
        },
        {
          handlerClass: 'AnalysisQueryToolHandler',
  ...
  it('renders fallback text input when apiBaseUrl is empty', async () => {
    renderWithProvider(<ToolEditor value="" apiBaseUrl="" onChange={jest.fn()} />);
