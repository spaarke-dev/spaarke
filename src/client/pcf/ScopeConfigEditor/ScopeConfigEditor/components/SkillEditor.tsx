...
import { makeStyles, tokens, shorthands, Label, Textarea, Text, Divider, Badge } from '@fluentui/react-components';
...
export const SkillEditor: React.FC<ISkillEditorProps> = ({
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.previewSection} id="skill-injection-preview" role="region" aria-label="Injection preview">
        <div className={styles.previewHeader}>
          <Text className={styles.previewLabel}>Injection preview — {skillName}</Text>
        </div>

        {value.trim() ? (
          <pre className={styles.previewContent} data-testid="injection-preview">
            {`## Skill: ${skillName}\n\n${value}`}
          </pre>
        ) : (
          <Text className={styles.emptyPreview} data-testid="injection-preview-empty">
