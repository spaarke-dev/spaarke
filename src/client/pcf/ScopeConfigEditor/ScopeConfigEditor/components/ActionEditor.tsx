...
import { makeStyles, tokens, Label, Textarea, Text, Badge } from '@fluentui/react-components';
...
function getTokenBadgeColor(tokens: number): 'success' | 'warning' | 'danger' | 'informative' {
...
export const ActionEditor: React.FC<IActionEditorProps> = ({ value, onChange, readOnly = false }) => {
    ...
    <div className={styles.container}>
      ...
      <div className={styles.statsRow} id="action-editor-stats" role="status" aria-live="polite">
        ...
        {tokenCount >= TOKEN_WARN_THRESHOLD && (
          <Text className={styles.statLabel} data-testid="token-warning" aria-live="assertive">
