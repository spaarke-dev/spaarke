...
export class AnalysisBuilder implements ComponentFramework.StandardControl<IInputs, IOutputs> {
  ...
  // Output values
  private _selectedPlaybookId = '';
  private _selectedActionId = '';
  private _selectedSkillIds = '';
  private _selectedKnowledgeIds = '';
  private _selectedToolIds = '';
  private _createdAnalysisId = '';
