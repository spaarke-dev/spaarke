/**
 * Jest setup for CommunicationConversationPanel PCF tests.
 *
 * Extends Jest matchers and stubs the platform globals (Xrm, ResizeObserver,
 * matchMedia, fetch) the React components touch at mount time. Mirrors
 * CommunicationTimelineRegarding/jest.setup.ts, with the Xrm page mock set to a
 * representative regarding-family host entity (sprk_matter).
 */
...
// ---------------------------------------------------------------------------
// fetch (nav-prop discovery / read wrappers)
// ---------------------------------------------------------------------------
