                ...
                <div className={styles.metricRow}>
                  ...
                  <Text
                    className={`${styles.metricValue} ${
                      stats.conversion.successRate >= 0.9
                        ? styles.successRate
                        : stats.conversion.successRate >= 0.7
                          ? styles.neutralRate
                          : styles.errorRate
                    }`}
                  >
            ...
            <Card className={styles.card}>
              ...
              <div className={styles.cardContent}>
                ...
                <div className={styles.metricRow}>
                  ...
                  <Text
                    className={`${styles.metricValue} ${
                      stats.webhook.acceptRate >= 0.9
                        ? styles.successRate
                        : stats.webhook.acceptRate >= 0.7
                          ? styles.neutralRate
                          : styles.errorRate
                    }`}
                  >
            ...
            <Card className={styles.card}>
              ...
              <div className={styles.cardContent}>
                ...
                <div className={styles.metricRow}>
                  ...
                  <Text
                    className={`${styles.metricValue} ${
                      stats.job.successRate >= 0.9
                        ? styles.successRate
                        : stats.job.successRate >= 0.7
                          ? styles.neutralRate
                          : styles.errorRate
                    }`}
                  >
