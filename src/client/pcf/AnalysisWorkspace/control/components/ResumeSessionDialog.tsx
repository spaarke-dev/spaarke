        ...
        <DialogBody>
          ...
          <DialogContent className={styles.content}>
            <Text>
              ...
              <strong>
                {chatMessageCount} message{chatMessageCount !== 1 ? 's' : ''}
              </strong>
              .
            </Text>
            <Text>Would you like to continue from where you left off, or start a fresh conversation?</Text>

            <div className={styles.optionsContainer}>
              <Button appearance="outline" className={styles.optionButton} onClick={handleResumeWithHistory}>
                <HistoryRegular className={styles.optionIcon} />
                <div className={styles.optionText}>
                  <span className={styles.optionTitle}>Resume Session</span>
                  <span className={styles.optionDescription}>Continue with your previous conversation history</span>
                </div>
              </Button>

              <Button appearance="outline" className={styles.optionButton} onClick={handleStartFresh}>
