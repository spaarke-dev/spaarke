 ...
 *
 * A WYSIWYG rich text editor built with Lexical for Analysis Output editing.
 * Designed for use in PCF controls across Model-Driven Apps, Power Apps Custom Pages,
 * and standalone web applications.
 *
 * Features:
