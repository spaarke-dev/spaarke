  ...
  return (
    <Toolbar className={toolbarClass} size="small">
      ...
      <Menu>
        ...
        <MenuPopover>
          <MenuList>
            <MenuItem icon={<TextIndentDecreaseRegular />} onClick={outdent}>
              Decrease Indent
            </MenuItem>
            <MenuItem icon={<TextIndentIncreaseRegular />} onClick={indent}>
              Increase Indent
            </MenuItem>
            <MenuDivider />
            <MenuItem
            ...
            {isLink && <MenuItem onClick={removeLink}>Remove Link</MenuItem>}
          </MenuList>
        </MenuPopover>
      </Menu>
