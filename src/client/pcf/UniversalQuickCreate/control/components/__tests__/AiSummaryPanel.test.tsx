...
describe("AiSummaryPanel", () => {
    ...
    it("should render with correct aria-label", () => {
      ...
      expect(
        screen.getByRole("article", {
          name: "AI summary for test-document.pdf",
        }),
      ).toBeInTheDocument();
    });
  });
  ...
  describe("status: complete", () => {
    ...
    it("should show full summary without cursor", () => {
      ...
      expect(
        summaryRegion.querySelector('[aria-hidden="true"]'),
  ...
  describe("status: error", () => {
    ...
    it("should show default error message when error prop is not provided", () => {
      ...
      expect(
        screen.getByText("An error occurred while generating the summary."),
      ).toBeInTheDocument();
    });
  ...
  describe("status: not-supported", () => {
    ...
    it("should show not-supported message", () => {
      renderWithProvider({ ...defaultProps, status: "not-supported" });
      expect(
        screen.getByText("File type not supported for AI summarization"),
      ).toBeInTheDocument();
    });
  });
  ...
  describe("accessibility", () => {
    it("should have proper aria-label for status badge", () => {
      ...
      expect(
        screen.getByLabelText("Summary status: Complete"),
      ).toBeInTheDocument();
    });
    ...
    it("should have proper aria-label for retry button", () => {
      ...
      expect(
        screen.getByRole("button", {
          name: "Retry summary for test-document.pdf",
        }),
      ).toBeInTheDocument();
    });
  });
