...
import { AiSummaryCarousel, AiSummaryCarouselProps, DocumentSummaryState } from '../AiSummaryCarousel';
...
describe('AiSummaryCarousel', () => {
  ...
  describe('single document', () => {
    it('should render AiSummaryPanel directly for single document', () => {
      const documents = [createDocument('doc-1', 'single-file.pdf', 'complete', 'Summary text')];
      renderWithProvider({ documents });
  ...
  describe('keyboard navigation', () => {
    ...
    it('should navigate with ArrowRight key', () => {
      ...
      const carousel = screen.getByRole('region', {
        name: /AI summaries for 3 documents/i,
      });
  ...
  describe('accessibility', () => {
    ...
    it('should have carousel role description', () => {
      renderWithProvider({ documents });
      const carousel = screen.getByRole('region', {
        name: /AI summaries for 2 documents/i,
      });
