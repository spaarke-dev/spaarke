...
module.exports = (env) => {
  ...
  const config = {
    ...
    plugins: [
      ...
      // NOTE: DefinePlugin for VITE_BFF_BASE_URL / VITE_MSAL_CLIENT_ID removed.
      // These values are now resolved at runtime from Dataverse Environment Variables
      // via resolveRuntimeConfig() in @spaarke/auth.
    ],
  };
