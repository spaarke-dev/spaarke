...
export function buildAnalysisRecord(overrides: Partial<AnalysisRecord> = {}): AnalysisRecord {
  return {
...
export function buildDraftAnalysis(overrides: Partial<AnalysisRecord> = {}): AnalysisRecord {
...
export function buildInProgressAnalysis(overrides: Partial<AnalysisRecord> = {}): AnalysisRecord {
  return buildAnalysisRecord({
...
export function buildDocumentMetadata(overrides: Partial<DocumentMetadata> = {}): DocumentMetadata {
  return {
    id: 'doc-001-test',
...
export function buildWordDocument(overrides: Partial<DocumentMetadata> = {}): DocumentMetadata {
...
export function buildAnalysisError(overrides: Partial<AnalysisError> = {}): AnalysisError {
  return {
