...
function formatSimilarity(similarity: number | undefined, isSource: boolean | undefined): string {
  if (isSource) return '';
 ...
 */
export function exportToCsv(rows: ExportableRow[], sourceDocumentName: string): void {
  const BOM = '\uFEFF';
