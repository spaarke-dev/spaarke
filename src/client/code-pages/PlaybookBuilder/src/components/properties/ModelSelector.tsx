...
import { makeStyles, tokens, shorthands, Dropdown, Option, Badge, Spinner, Text } from '@fluentui/react-components';
...
export const ModelSelector = memo(function ModelSelector({ modelDeploymentId, onModelChange }: ModelSelectorProps) {
