...
export const NodePropertiesDialog = memo(function NodePropertiesDialog() {
  ...
  const handlePromptSchemaChange = useCallback(
    (schema: PromptSchema) => {
      if (selectedNode)
        updateNodeData(selectedNode.id, { promptSchema: schema });
    },
    [selectedNode, updateNodeData],
  );
                    ...
                    <div className={styles.fieldRow}>
                      <div className={styles.fieldCol}>
                        ...
                        <Input
                          ...
                          onChange={(_, data) =>
                            handleUpdate("label", data.value)
                          }
                        />
                      </div>
                      {!isStartNode && (
                        <div className={styles.fieldCol}>
                          <Label htmlFor={`${selectedNode.id}-outputVar`}>
                            Output Variable
                          </Label>
                          <Input
                    ...
                    {isAiNode && (
                      <>
                        ...
                        <div className={styles.fieldGroup}>
                          <ModelSelector
                            modelDeploymentId={
                              selectedNode.data.modelDeploymentId
                            }
                            onModelChange={(id) =>
                              handleUpdate("modelDeploymentId", id)
                            }
                          />
                        </div>
                      </>
                  ...
                  <>
                    ...
                    {isConditionNode && (
                      <div className={styles.fieldGroup}>
                        ...
                        <ConditionEditor
                          conditionJson={
                            selectedNode.data.conditionJson ?? "{}"
                          }
                        ...
                        <div className={styles.fieldRow}>
                          <div className={styles.fieldCol}>
                            ...
                            <SpinButton
                              ...
                              step={30}
                              value={
                                selectedNode.data.timeoutSeconds ?? 300
                              }
                              onChange={(_, data) =>
                                handleUpdate(
                                  "timeoutSeconds",
