                            ...
                            <>
                                    ...
                                    <>
                                        ...
                                        {isAiNode && (
                                            <>
                                                ...
                                                <Text weight="semibold" size={300} className={styles.sectionTitle}>Action</Text>
                                        ...
                                        {isAiNode && (
                                            <>
                                                <Divider className={styles.sectionTitle} />
                                                <Text weight="semibold" size={300} className={styles.sectionTitle}>AI Model</Text>
                                                <div className={styles.fieldGroup}>
                                                    <ModelSelector
                                ...
                                {activeTab === "configuration" && (
                                    <>
                                        {hasTypeForm && (
                                            <div className={styles.fieldGroup}>
                                                {nodeType === "deliverOutput" && (
                                                    <DeliverOutputForm nodeId={selectedNode.id} data={selectedNode.data} onUpdate={handleUpdate} />
                                                )}
                                                {nodeType === "deliverToIndex" && (
                                                    <DeliverToIndexForm nodeId={selectedNode.id} data={selectedNode.data} onUpdate={handleUpdate} />
                                                )}
                                                {nodeType === "updateRecord" && (
                                                    <UpdateRecordForm nodeId={selectedNode.id} configJson={selectedNode.data.configJson ?? "{}"} onConfigChange={handleConfigChange} />
                                                )}
                                                {nodeType === "sendEmail" && (
                                                    <SendEmailForm nodeId={selectedNode.id} configJson={selectedNode.data.configJson ?? "{}"} onConfigChange={handleConfigChange} />
                                                )}
                                                {nodeType === "createTask" && (
                                                    <CreateTaskForm nodeId={selectedNode.id} configJson={selectedNode.data.configJson ?? "{}"} onConfigChange={handleConfigChange} />
                                                )}
                                                {nodeType === "aiCompletion" && (
                                                    <AiCompletionForm nodeId={selectedNode.id} configJson={selectedNode.data.configJson ?? "{}"} onConfigChange={handleConfigChange} />
                                                )}
                                                {nodeType === "wait" && (
                                                    <WaitForm nodeId={selectedNode.id} configJson={selectedNode.data.configJson ?? "{}"} onConfigChange={handleConfigChange} />
                                                )}
                                            </div>
                                        )}
                                        ...
                                        {isConditionNode && (
                                            <div className={styles.fieldGroup}>
                                                <Text weight="semibold" size={300}>Condition</Text>
                                                <ConditionEditor
                                        ...
                                        {!isStartNode && (
                                            <>
                                                ...
                                                <Text weight="semibold" size={300} className={styles.sectionTitle}>Runtime Settings</Text>
                                                <div className={styles.fieldRow}>
                                                    <div className={styles.fieldCol}>
