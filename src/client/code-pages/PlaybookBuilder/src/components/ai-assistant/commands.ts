...
export const NODE_TYPE_INFO: Record<PlaybookNodeType, { label: string; description: string }> = {
  start: {
    label: 'Start',
  ...
  entityNameValidator: {
    ...
    description: 'Scrub LLM-emitted entity names not present in an allow-list (logs hallucination_detected)',
  },
  wait: {
    label: 'Wait',
