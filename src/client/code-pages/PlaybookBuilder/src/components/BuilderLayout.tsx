...
export function BuilderLayout({ playbookId }: BuilderLayoutProps): JSX.Element {
  ...
  const handleSave = useCallback(async () => {
    ...
    try {
      ...
      await syncNodesToDataverse(
        activeId,
        nodes,
        edges,
        getInitialNodeScopes(),
      );
      markSaved();
      setSaveStatus("saved");
    ...
    <div className={styles.root}>
      ...
      <div className={styles.toolbar}>
        <div className={styles.toolbarLeft}>
          <Tooltip
            content={leftPanelOpen ? "Hide node palette" : "Show node palette"}
            relationship="label"
          >
            <Button
              appearance="subtle"
        ...
        <div className={styles.toolbarRight}>
          <Tooltip
            content={isExecuting ? "Execution in progress" : "Run playbook"}
            relationship="label"
          >
            <Button
              appearance="subtle"
