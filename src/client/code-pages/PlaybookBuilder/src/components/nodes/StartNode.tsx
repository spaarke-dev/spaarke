 ...
 */
export const StartNode = React.memo(function StartNode({ data, selected }: NodeProps<Node<PlaybookNodeData>>) {
  return (
    <BaseNode data={data} selected={selected} icon={<Play20Regular />} typeLabel="Start" targetHandleCount={0}>
