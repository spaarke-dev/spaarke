...
export const useScopeStore = create<ScopeStoreState>()((set, get) => ({
  ...
  loadSkills: async () => {
    ...
    try {
      ...
      console.info(
        `${LOG_PREFIX} Loaded ${skills.length} skills from Dataverse`,
      );
    } catch (err) {
      const message =
  ...
  loadKnowledge: async () => {
    ...
    try {
      ...
      console.info(
        `${LOG_PREFIX} Loaded ${knowledge.length} knowledge sources from Dataverse`,
      );
    } catch (err) {
      const message =
  ...
  loadActions: async () => {
    ...
    try {
      ...
      console.info(
        `${LOG_PREFIX} Loaded ${actions.length} actions from Dataverse`,
      );
    } catch (err) {
      const message =
