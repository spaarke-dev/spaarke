  ...
  // -----------------------------------------------------------------
  {
    ...
    schema: {
      ...
      instruction: {
        ...
        constraints: ['Only use information present in the document', 'Return exactly one classification'],
      },
      input: {
        document: {
          required: true,
  ...
  // -----------------------------------------------------------------
  {
    ...
    schema: {
        ...
        fields: [
          {
            ...
            type: 'array',
            items: { type: 'string' },
            description: 'Named parties, organizations, or individuals mentioned in the document',
          },
          {
            name: 'keyDates',
            type: 'array',
            ...
            description: 'Important dates and deadlines found in the document',
          },
          {
            name: 'summary',
            type: 'string',
      ...
      examples: [
        {
          input:
            'Agreement between Acme Corp and Beta Inc effective January 15, 2026, with renewal on January 15, 2027...',
          output: {
            ...
            summary: 'Agreement between Acme Corp and Beta Inc with a one-year term starting January 2026.',
            confidence: 0.91,
          },
        },
      ],
      metadata: {
        author: 'template',
        authorLevel: 0,
        description: 'Extract entities, dates, and parties from documents',
  ...
  // -----------------------------------------------------------------
  {
    ...
    schema: {
      ...
      instruction: {
        ...
        constraints: ['Provide evidence for each risk factor', 'Rate each factor individually'],
      },
      input: {
        document: {
          required: true,
      ...
      output: {
        fields: [
          ...
          },
          {
            ...
            items: {
              ...
              properties: {
                factor: {
                  type: 'string',
                  description: 'Name or short description of the risk factor',
                },
                severity: {
                  type: 'string',
                ...
                evidence: {
                  type: 'string',
                  description: 'Excerpt or reference from the document supporting this risk',
                },
              },
            },
            description: 'Individual risk factors identified in the document',
          },
          {
          ...
          },
          {
            name: 'overallScore',
            type: 'number',
            description: 'Numeric risk score from 0 (no risk) to 100 (critical risk)',
            minimum: 0,
            maximum: 100,
          },
        ],
            ...
            riskFactors: [
              {
                ...
                severity: 'high',
                evidence: '"unlimited liability for consequential damages" — exposes significant financial risk.',
              },
            ],
            recommendations: [
      ...
      metadata: {
        author: 'template',
        authorLevel: 0,
        description: 'Assess risk level and flag concerns in documents',
        tags: ['risk', 'assessment', 'compliance'],
      },
    },
  },
  ...
  // -----------------------------------------------------------------
  {
    ...
    schema: {
      ...
      instruction: {
        ...
        constraints: ['Keep summary under 500 characters', 'Action items must be specific and actionable'],
      },
      input: {
        document: {
          required: true,
        ...
        fields: [
          {
            name: 'summary',
            type: 'string',
            description: 'Concise executive summary of the document',
            maxLength: 500,
          },
          {
            name: 'keyPoints',
            type: 'array',
            items: { type: 'string' },
            description: 'Most important points from the document',
          },
          {
            name: 'actionItems',
            type: 'array',
            items: {
              ...
              properties: {
                ...
                assignee: {
                  type: 'string',
                  description: 'Suggested assignee if identifiable from the document',
                },
              },
            },
            description: 'Specific, actionable items extracted from the document',
          },
          {
            name: 'documentLength',
            type: 'string',
            description: 'Relative length classification of the original document',
      ...
      examples: [
        {
          input:
            'Board meeting minutes from March 1, 2026. Topics: Q1 budget approval, new hire plan, office relocation timeline...',
          output: {
            summary:
      ...
      metadata: {
        author: 'template',
        authorLevel: 0,
        description: 'Generate executive summary with key points and action items',
        tags: ['summary', 'executive', 'action-items'],
      },
    },
  },
  ...
  // -----------------------------------------------------------------
  {
    ...
    schema: {
      ...
      output: {
        fields: [
          ...
          },
          {
            name: 'expirationDate',
            type: 'string',
            description: 'Contract expiration or termination date in ISO 8601 format',
          },
          {
            name: 'keyTerms',
            type: 'array',
            items: {
              ...
              properties: {
                term: {
                  type: 'string',
                  description: 'Name of the key contractual term',
                },
                description: {
                  type: 'string',
                  description: "Summary of the term's provisions",
                },
              },
            },
            description: 'Key contractual terms and their descriptions',
          },
          {
            name: 'obligations',
            type: 'array',
            items: {
              ...
              properties: {
                party: {
                  type: 'string',
                  description: 'The party responsible for the obligation',
                },
                obligation: {
                  type: 'string',
            ...
            description: 'Specific obligations for each party',
          },
          {
            name: 'concerns',
            type: 'array',
            items: {
              ...
              properties: {
                issue: {
                  type: 'string',
                  description: 'Description of the concern or issue',
                },
                severity: {
                  type: 'string',
                  description: 'Severity level: low, medium, high, or critical',
                ...
                clause: {
                  type: 'string',
                  description: 'Reference to the specific clause, if applicable',
                },
              },
            },
            description: 'Potential issues, unusual clauses, or missing standard provisions',
          },
          {
            name: 'isConfidential',
            type: 'boolean',
            description: 'Whether the contract contains confidentiality or NDA provisions',
          },
          {
            name: 'riskLevel',
            type: 'string',
      ...
      examples: [
        {
          input:
            'CONSULTING AGREEMENT between Acme Corp ("Client") and Legal Partners LLC ("Consultant") effective March 1, 2026, expiring February 28, 2027...',
          output: {
            ...
            keyTerms: [
              {
                ...
                description: 'Consultant to provide legal advisory services as defined in Exhibit A.',
              },
              {
                term: 'Payment Terms',
                description: 'Monthly retainer of $15,000 due within 30 days of invoice.',
              },
            ],
            obligations: [
              {
                party: 'Acme Corp',
                obligation: 'Provide timely access to relevant documents and personnel.',
              },
              {
                party: 'Legal Partners LLC',
                obligation: 'Deliver monthly status reports by the 5th of each month.',
              },
            ],
            concerns: [
              {
      ...
      metadata: {
        author: 'template',
        authorLevel: 0,
        description: 'Legal contract analysis with key terms, obligations, and concerns',
 ...
 */
export function getTemplateById(id: string): PromptSchemaTemplate | undefined {
