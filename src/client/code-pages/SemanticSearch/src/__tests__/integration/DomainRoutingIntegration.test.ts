...
import type { DocumentSearchResponse, RecordSearchResponse, SearchFilters } from '../../types';
...
describe('DomainRoutingIntegration', () => {
  ...
  describe('Matters domain', () => {
    it('should route to POST /api/ai/search/records', async () => {
      mockFetch.mockResolvedValue(createFetchResponse(makeRecordResponse(RecordEntityTypes.Matter)));
  ...
  describe('Projects domain', () => {
    it('should route to POST /api/ai/search/records', async () => {
      mockFetch.mockResolvedValue(createFetchResponse(makeRecordResponse(RecordEntityTypes.Project)));
  ...
  describe('Invoices domain', () => {
    it('should route to POST /api/ai/search/records', async () => {
      mockFetch.mockResolvedValue(createFetchResponse(makeRecordResponse(RecordEntityTypes.Invoice)));
  ...
  describe('Cross-domain endpoint isolation', () => {
    it('should use different endpoints for document vs. record search', async () => {
      ...
      // Record search
      mockFetch.mockResolvedValueOnce(createFetchResponse(makeRecordResponse(RecordEntityTypes.Matter)));
    ...
    it('should use same /api/ai/search/records endpoint for all record domains', async () => {
      const domains = [RecordEntityTypes.Matter, RecordEntityTypes.Project, RecordEntityTypes.Invoice];

      for (const entityType of domains) {
        mockFetch.mockResolvedValueOnce(createFetchResponse(makeRecordResponse(entityType)));
      }
