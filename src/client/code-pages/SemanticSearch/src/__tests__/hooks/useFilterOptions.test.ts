...
describe('useFilterOptions', () => {
  ...
  describe('documentTypes', () => {
    it('should fetch document types from optionset metadata', async () => {
      ...
      expect(mockFetchOptionsetValues).toHaveBeenCalledWith('sprk_document', 'sprk_documenttype');
  ...
  describe('matterTypes', () => {
    it('should fetch matter types from lookup entity', async () => {
      ...
      expect(mockFetchLookupValues).toHaveBeenCalledWith('sprk_mattertype_refs', 'sprk_mattertypename');
  ...
  describe('refresh()', () => {
    it('should call clearCache before re-fetching', async () => {
      ...
      mockFetchOptionsetValues.mockResolvedValue([{ value: 'new-1', label: 'New Type' }]);
    ...
    it('should update state with refreshed options', async () => {
      ...
      const updatedDocTypes: FilterOption[] = [{ value: '99', label: 'Updated Type' }];
