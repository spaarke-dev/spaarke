...
const mockFetchOptionsetValues = jest.fn<
  Promise<FilterOption[]>,
  [string, string]
>();
const mockFetchLookupValues = jest.fn<
  Promise<FilterOption[]>,
  [string, string]
>();
...
jest.mock("../../services/DataverseWebApiService", () => ({
  fetchOptionsetValues: (...args: [string, string]) =>
    mockFetchOptionsetValues(...args),
  fetchLookupValues: (...args: [string, string]) =>
    mockFetchLookupValues(...args),
...
describe("useFilterOptions", () => {
  ...
  describe("error handling", () => {
    it("should set error when fetchOptionsetValues rejects", async () => {
      mockFetchOptionsetValues.mockRejectedValue(
        new Error("Optionset API failed"),
      );
      const { result } = renderHook(() => useFilterOptions());
