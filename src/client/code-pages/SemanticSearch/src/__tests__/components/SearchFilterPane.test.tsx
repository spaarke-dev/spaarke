...
} from "../../components/SearchFilterPane";
...
describe("SearchFilterPane", () => {
  ...
  describe("filter placeholders", () => {
    it("shows FilterDropdown placeholder for Document Type", () => {
      ...
      expect(
        screen.getByText("[FilterDropdown: Document Type]"),
      ).toBeInTheDocument();
    });
    ...
    it("shows FilterDropdown placeholder for File Type", () => {
      ...
      expect(
        screen.getByText("[FilterDropdown: File Type]"),
      ).toBeInTheDocument();
    });
    ...
    it("shows FilterDropdown placeholder for Matter Type", () => {
      ...
      expect(
        screen.getByText("[FilterDropdown: Matter Type]"),
      ).toBeInTheDocument();
    });
    ...
    it("shows DateRangeFilter placeholder", () => {
      ...
      expect(
        screen.getByText("[DateRangeFilter: Date Range]"),
      ).toBeInTheDocument();
    });
  });
});
