...
export class DocumentRecordService {
     ...
     */
    async createDocuments(files, parentContext, formData) {
     ...
     */
    async updateSummary(documentId, summary) {
        try {
     ...
     */
    async createSingleDocument(file, parentContext, formData) {
        try {
            ...
            const payload = this.buildRecordPayload(file, parentContext, formData, navigationPropertyName, targetEntitySetName);
     ...
     */
    buildRecordPayload(file, parentContext, formData, navigationPropertyName, entitySetName) {
...
//# sourceMappingURL=DocumentRecordService.js.map