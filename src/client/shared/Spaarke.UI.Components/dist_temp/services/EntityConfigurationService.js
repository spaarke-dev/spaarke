...
export class EntityConfigurationService {
     ...
     */
    static loadConfiguration(configJson) {
        if (!configJson) {
     ...
     */
    static getEntityConfiguration(entityLogicalName) {
     ...
     */
    static getCustomCommand(entityLogicalName, commandKey) {
     ...
     */
    static validateConfiguration(configJson) {
        const errors = [];
        try {
            const parsed = JSON.parse(configJson);
            ...
            Object.entries(parsed.entityConfigs || {}).forEach(([entityName, config]) => {
...
EntityConfigurationService.schema = null;
//# sourceMappingURL=EntityConfigurationService.js.map