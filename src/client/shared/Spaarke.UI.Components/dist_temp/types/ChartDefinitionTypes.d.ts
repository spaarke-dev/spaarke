 ...
 */
export interface IChartDefinitionParsed<TOptions = IChartOptionsBase> extends Omit<IChartDefinition, 'sprk_optionsjson'> {
 ...
 */
export type ChartOptions = IMetricCardOptions | IBarChartOptions | ILineChartOptions | IAreaChartOptions | IDonutChartOptions | IStatusBarOptions | ICalendarOptions | IMiniTableOptions;
/**
 ...
 */
export type OptionsForVisualType<T extends VisualType> = T extends keyof VisualTypeOptionsMap ? VisualTypeOptionsMap[T] : IChartOptionsBase;
/**
...
//# sourceMappingURL=ChartDefinitionTypes.d.ts.map