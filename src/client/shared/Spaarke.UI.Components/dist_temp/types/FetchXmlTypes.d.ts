 ...
 */
export type ColumnDataType = 'string' | 'integer' | 'decimal' | 'money' | 'datetime' | 'date' | 'boolean' | 'lookup' | 'optionset' | 'status' | 'owner' | 'memo' | 'uniqueidentifier' | 'image' | 'file';
/**
 ...
 */
export type ViewType = 'savedquery' | 'userquery' | 'custom';
/**
 ...
 */
export type FetchXmlOperator = 'eq' | 'ne' | 'gt' | 'ge' | 'lt' | 'le' | 'like' | 'not-like' | 'in' | 'not-in' | 'between' | 'not-between' | 'null' | 'not-null' | 'on' | 'on-or-before' | 'on-or-after' | 'today' | 'yesterday' | 'tomorrow' | 'last-x-days' | 'next-x-days' | 'this-week' | 'this-month' | 'this-year';
/**
...
//# sourceMappingURL=FetchXmlTypes.d.ts.map