 ...
 */
export declare const FieldTypeLabels: Record<FieldType, string>;
/**
 ...
 */
export declare const MappingDirectionLabels: Record<MappingDirection, string>;
/**
 ...
 */
export declare const SyncModeLabels: Record<SyncMode, string>;
/**
 ...
 */
export declare const CompatibilityModeLabels: Record<CompatibilityMode, string>;
/**
 ...
 */
export declare enum MappingErrorCode {
 ...
 */
export declare const STRICT_TYPE_COMPATIBILITY: Record<FieldType, FieldType[]>;
/**
...
//# sourceMappingURL=FieldMappingTypes.d.ts.map