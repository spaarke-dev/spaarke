...
export interface IWebApiLike {
     ...
     */
    retrieveMultipleRecords(entityType: string, options?: string, maxPageSize?: number): Promise<IWebApiRetrieveMultipleResponse>;
}
/**
 ...
 * ```
 */
export declare function createWebApiFromXrm(xrmWebApi: {
    retrieveRecord: (entityType: string, id: string, options?: string) => Promise<Record<string, unknown>>;
    retrieveMultipleRecords: (entityType: string, options?: string, maxPageSize?: number) => Promise<IWebApiRetrieveMultipleResponse>;
}): IWebApiLike;
//# sourceMappingURL=WebApiLike.d.ts.map