 ...
 * ```
 */
export function createBffDataService(authenticatedFetch, bffBaseUrl) {
     ...
     */
    function buildUrl(entityName, id, options) {
...
//# sourceMappingURL=bffDataServiceAdapter.js.map