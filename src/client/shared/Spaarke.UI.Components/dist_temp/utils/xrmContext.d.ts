 ...
 * ```
 */
export declare function detectThemeFromHost(): {
    isDarkTheme: boolean;
    source: 'xrm' | 'default';
};
/**
 ...
 */
export declare function getClientUrl(): string | undefined;
/**
...
//# sourceMappingURL=xrmContext.d.ts.map