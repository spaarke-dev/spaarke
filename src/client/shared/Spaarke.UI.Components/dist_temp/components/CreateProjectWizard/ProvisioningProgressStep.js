...
import { PROVISIONING_STEPS } from './provisioningService';
// ---------------------------------------------------------------------------
// Styles
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
export const ProvisioningProgressStep = ({ steps, errorMessage, }) => {
    ...
    return (React.createElement("div", { className: styles.root },
        React.createElement("div", { className: styles.header },
            React.createElement(Text, { as: "h2", size: 500, weight: "semibold", className: styles.title }, hasError
                ? 'Provisioning failed'
                : isComplete
                    ? 'Infrastructure provisioned!'
                    : 'Setting up Secure Project\u2026'),
            React.createElement(Text, { size: 200, className: styles.subtitle }, hasError
        ...
        React.createElement("div", { className: styles.stepList, role: "list", "aria-label": "Provisioning steps" }, steps.map((step) => {
            const stepDef = PROVISIONING_STEPS.find((s) => s.key === step.key);
            const label = stepDef?.label ?? step.key;
            return (React.createElement("div", { key: step.key, className: styles.stepRow, role: "listitem" },
                step.status === 'pending' && (React.createElement("div", { className: styles.stepIconPending, "aria-hidden": "true" })),
                step.status === 'active' && (React.createElement(Spinner, { size: "extra-tiny", className: styles.stepIconActive, "aria-label": "In progress" })),
                step.status === 'done' && (React.createElement("span", { className: styles.stepIconDone, "aria-label": "Complete" },
                    React.createElement(CheckmarkCircleFilled, { fontSize: 16 }))),
                step.status === 'error' && (React.createElement("span", { className: styles.stepIconError, "aria-label": "Failed" },
                    React.createElement(DismissCircleFilled, { fontSize: 16 }))),
                React.createElement(Text, { size: 300, className: step.status === 'pending'
                        ? styles.stepTextPending
                        : step.status === 'active'
                            ? styles.stepTextActive
                            : step.status === 'done'
                                ? styles.stepTextDone
                                : styles.stepTextError }, step.status === 'done'
                    ? label.replace('\u2026', '')
                    : label)));
        })),
        errorMessage && (React.createElement(MessageBar, { intent: "error", className: styles.errorBar },
...
//# sourceMappingURL=ProvisioningProgressStep.js.map