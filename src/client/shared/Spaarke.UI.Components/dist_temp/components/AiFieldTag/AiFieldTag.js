 ...
 */
export const AiFieldTag = ({ className }) => {
    const styles = useStyles();
    return (React.createElement("span", { className: mergeClasses(styles.tag, className), role: "img", "aria-label": "AI pre-filled", title: "This field was pre-filled by AI analysis" },
        React.createElement("span", { className: styles.icon, "aria-hidden": "true" },
            React.createElement(SparkleRegular, null)),
        React.createElement(Text, { className: styles.label, "aria-hidden": "true" }, "AI")));
};
//# sourceMappingURL=AiFieldTag.js.map