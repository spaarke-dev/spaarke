...
export type { IDiffCompareViewProps, IDiffSegment, DiffCompareViewMode, DiffOptions, DiffResult, DiffStats, BlockChange, BlockChangeType, } from './DiffCompareView.types';
