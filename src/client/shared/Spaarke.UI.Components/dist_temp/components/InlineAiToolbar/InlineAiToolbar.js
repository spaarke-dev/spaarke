 ...
 * ```
 */
export const InlineAiToolbar = ({ visible, position, actions, onAction, }) => {
    const styles = useStyles();
    return (React.createElement("div", { className: mergeClasses(styles.toolbar, !visible && styles.hidden), style: {
            top: position.top,
            left: position.left,
        }, role: "toolbar", "aria-label": "AI inline actions", "aria-hidden": !visible, "data-testid": "inline-ai-toolbar" },
        React.createElement(InlineAiActions, { actions: actions, onAction: onAction })));
};
//# sourceMappingURL=InlineAiToolbar.js.map