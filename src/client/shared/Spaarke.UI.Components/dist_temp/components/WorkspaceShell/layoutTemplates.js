...
const THREE_ROW_MIXED = {
    id: "3-row-mixed",
    name: "Three Row",
    description: "Two columns top and bottom with a full-width middle row. Default layout.",
    rows: [
        { id: "row-1", gridTemplateColumns: "1fr 1fr", slotCount: 2 },
...
//# sourceMappingURL=layoutTemplates.js.map