 ...
 * ```
 */
export function useDocumentStreamConsumer(options) {
    ...
    const activeOperationIdRef = useRef(null);
    ...
    // Event handlers
    // ─────────────────────────────────────────────────────────────────────
    const handleStreamStart = useCallback((payload) => {
        ...
        const position = payload.targetPosition === 'cursor' ? 'cursor' : 'end';
        try {
    ...
    const handleStreamToken = useCallback((payload) => {
    ...
    const handleStreamEnd = useCallback((payload) => {
...
//# sourceMappingURL=useDocumentStreamConsumer.js.map