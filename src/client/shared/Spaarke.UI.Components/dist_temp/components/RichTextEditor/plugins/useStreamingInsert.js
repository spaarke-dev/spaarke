 ...
 * ```
 */
export function useStreamingInsert(onComplete) {
    ...
    const handleStreamingComplete = useCallback((cancelled) => {
        setIsStreaming(false);
        onComplete?.(operationIdRef.current, cancelled);
    }, [onComplete]);
    const startStream = useCallback((opId, targetPosition) => {
    ...
    const endStream = useCallback((cancelled) => {
...
//# sourceMappingURL=useStreamingInsert.js.map