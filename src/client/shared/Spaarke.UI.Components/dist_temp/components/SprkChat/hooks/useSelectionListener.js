 ...
 */
function parseSelectionContext(contextStr) {
 ...
 * ```
 */
export function useSelectionListener(options) {
    ...
    useEffect(() => {
        ...
        const handleSelectionChanged = (payload) => {
...
//# sourceMappingURL=useSelectionListener.js.map