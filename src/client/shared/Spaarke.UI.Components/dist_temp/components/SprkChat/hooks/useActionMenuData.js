 ...
 */
function buildCacheKey(sessionId, entityType) {
 ...
 */
function transformApiActions(apiActions) {
 ...
 * ```
 */
export function useActionMenuData(options) {
...
//# sourceMappingURL=useActionMenuData.js.map