...
export interface IChatMessageMetadata {
     ...
     */
    responseType?: 'markdown' | 'citations' | 'diff' | 'entity_card' | 'action_confirmation' | 'plan_preview' | 'document_status' | string;
    /**
 ...
 */
export type ChatSseEventType = 'token' | 'done' | 'error' | 'suggestions' | 'citations' | 'typing_start' | 'typing_end' | 'plan_preview' | 'plan_step_start' | 'plan_step_complete' | 'document_processing_start' | 'document_processing_complete' | 'document_processing_error' | 'action_confirmation' | 'action_success' | 'action_error' | 'dialog_open' | 'navigate' | 'document_stream_start' | 'document_stream_token' | 'document_stream_end';
...
export declare const DEFAULT_QUICK_ACTIONS: IQuickAction[];
/**
...
export declare const CROSS_PANE_SELECTION_MAX_PREVIEW = 5000;
/**
 ...
 */
export declare const DOCUMENT_PROCESSING_TIMEOUT_MS = 15000;
/**
...
export interface IUseChatSessionResult {
     ...
     */
    updateMessageMetadataAt: (index: number, metadataOrUpdater: IChatMessageMetadata | ((current: IChatMessageMetadata | undefined) => IChatMessageMetadata)) => void;
}
