 ...
 * ```
 */
export const SprkChatTypingIndicator = () => {
    const styles = useStyles();
    return (React.createElement("div", { className: styles.container, role: "status", "aria-label": "AI is thinking", "data-testid": "typing-indicator" },
...
//# sourceMappingURL=SprkChatTypingIndicator.js.map