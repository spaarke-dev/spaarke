...
import { DocumentAddRegular, DocumentDismissRegular, CheckmarkCircleRegular, ErrorCircleRegular, } from '@fluentui/react-icons';
// ─────────────────────────────────────────────────────────────────────────────
// Constants
// ─────────────────────────────────────────────────────────────────────────────
 ...
 * ```
 */
export const SprkChatUploadZone = ({ sessionId, apiBaseUrl, accessToken, onUploadComplete, onUploadError, disabled = false, }) => {
    const styles = useStyles();
    // ── State ──────────────────────────────────────────────────────────────────
    const [phase, setPhase] = React.useState('dragging');
    const [uploadProgress, setUploadProgress] = React.useState(0);
    const [errorMessage, setErrorMessage] = React.useState(null);
    const [isDragOverValid, setIsDragOverValid] = React.useState(null);
    ...
    // ── Render ─────────────────────────────────────────────────────────────────
    return (React.createElement("div", { className: overlayClass, onDragEnter: handleDragEnter, onDragOver: handleDragOver, onDragLeave: handleDragLeave, onDrop: handleDrop, role: "region", "aria-label": "File upload drop zone", "data-testid": "sprkchat-upload-zone" },
        React.createElement("div", { className: styles.content },
            phase === 'dragging' && isDragOverValid !== false && (React.createElement(React.Fragment, null,
                React.createElement(DocumentAddRegular, { className: styles.icon }),
                React.createElement(Text, { className: styles.title }, "Drop to analyze"),
                React.createElement(Text, { className: styles.subtitle },
                    "Accepted: ",
                    ACCEPTED_TYPES_LABEL,
                    " (max 50 MB)"))),
            phase === 'dragging' && isDragOverValid === false && (React.createElement(React.Fragment, null,
                React.createElement(DocumentDismissRegular, { className: styles.iconError }),
                React.createElement(Text, { className: styles.title }, "Unsupported file type"),
                React.createElement(Text, { className: styles.subtitle },
                    "Accepted: ",
                    ACCEPTED_TYPES_LABEL))),
            phase === 'rejected' && (React.createElement(React.Fragment, null,
                React.createElement(DocumentDismissRegular, { className: styles.iconError }),
                React.createElement(Text, { className: styles.title }, "File not accepted"),
                React.createElement(Text, { className: styles.errorText }, errorMessage))),
            phase === 'uploading' && (React.createElement(React.Fragment, null,
                React.createElement(Spinner, { size: "medium", label: "Uploading..." }),
                React.createElement("div", { className: styles.progressContainer },
                    React.createElement(ProgressBar, { className: styles.progressBar, value: uploadProgress / 100, max: 1 }),
                    React.createElement(Text, { className: styles.progressLabel },
                        uploadProgress,
                        "%")))),
            phase === 'success' && (React.createElement(React.Fragment, null,
                React.createElement(CheckmarkCircleRegular, { className: styles.iconSuccess }),
                React.createElement(Text, { className: styles.title }, "Upload complete"),
                React.createElement(Text, { className: styles.subtitle }, "Document is being processed..."))),
            phase === 'error' && (React.createElement(React.Fragment, null,
                React.createElement(ErrorCircleRegular, { className: styles.iconError }),
                React.createElement(Text, { className: styles.title }, "Upload failed"),
                React.createElement(Text, { className: styles.errorText }, errorMessage))))));
};
export default SprkChatUploadZone;
//# sourceMappingURL=SprkChatUploadZone.js.map