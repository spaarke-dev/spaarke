...
import { PersonRegular, DocumentTextRegular, MailRegular, CheckboxCheckedRegular, CheckboxUncheckedRegular, } from '@fluentui/react-icons';
// ---------------------------------------------------------------------------
// Card definitions
// ---------------------------------------------------------------------------
const CARD_DEFS = [
    ...
    },
    {
        ...
        icon: React.createElement(DocumentTextRegular, { fontSize: 28 }),
    },
    {
        id: 'send-email',
...
// ---------------------------------------------------------------------------
export const NextStepsStep = ({ selectedActions, onSelectionChange, entityLabel = 'matter', }) => {
    const styles = useStyles();
...
//# sourceMappingURL=NextStepsStep.js.map