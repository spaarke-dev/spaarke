...
// Component
// ---------------------------------------------------------------------------
export function PanelSplitter({ onMouseDown, onKeyDown, onDoubleClick, isDragging, currentRatio, }) {
    const styles = useStyles();
    // Convert ratio (0-1) to integer percentage for ARIA
    const valueNow = Math.round(currentRatio * 100);
    return (React.createElement("div", { className: mergeClasses(styles.splitter, isDragging && styles.splitterDragging), role: "separator", "aria-orientation": "vertical", "aria-valuenow": valueNow, "aria-valuemin": 0, "aria-valuemax": 100, "aria-label": "Resize panels", tabIndex: 0, onMouseDown: onMouseDown, onKeyDown: onKeyDown, onDoubleClick: onDoubleClick },
        React.createElement("div", { className: styles.grip },
            React.createElement("div", { className: styles.gripDot }),
            React.createElement("div", { className: styles.gripDot }),
            React.createElement("div", { className: styles.gripDot }))));
}
//# sourceMappingURL=PanelSplitter.js.map