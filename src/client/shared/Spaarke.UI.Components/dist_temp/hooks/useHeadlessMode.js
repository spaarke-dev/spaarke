...
export function useHeadlessMode(props) {
    ...
    const fetchData = useCallback(async (page, cookie) => {
        setLoading(true);
        setError(null);
        try {
            ...
            // Extract records
            const fetchedRecords = response.entities.map((entity) => {
                const record = {
            ...
            const nextCookie = response['@Microsoft.Dynamics.CRM.fetchxmlpagingcookie'];
...
//# sourceMappingURL=useHeadlessMode.js.map