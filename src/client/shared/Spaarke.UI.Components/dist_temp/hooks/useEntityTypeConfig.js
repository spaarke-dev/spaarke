 ...
 */
export function useEntityTypeConfig(options) {
    ...
    React.useEffect(() => {
        ...
        async function fetchConfig() {
            ...
            try {
                ...
                const configJson = record[configFieldName] ?? null;
                // Extract name field (convention: look for common name patterns)
                const nameValue = record['sprk_name'] ?? record['name'] ?? null;
...
//# sourceMappingURL=useEntityTypeConfig.js.map