...
export const DefaultSprkEvent = (args: StoryArgs) => {
  ...
  return withFluentProvider(
    args.theme,
    <DataGrid
      configId="sprk_event_default"
      dataverseClient={client}
      onRecordOpen={(id) => alert(`Opened: ${id}`)}
    />,
  );
};
