 ...
 * forms, Code Page wizards) sizes itself from one of these three named
 * constants — never an inline width/height percentage literal at the call site.
 *
...
/**
 * The three sanctioned OOB modal size names (spec FR-11). No fourth size —
 * a launch site that genuinely needs a different size is a documented
 * escalation (see `projects/spaarke-modal-system/notes/oob-navigateto-inventory.md`
 * "flagged for visual review"), not a new entry here.
 */
 ...
 *
 * @param name - One of the three sanctioned OOB modal size names.
 */
