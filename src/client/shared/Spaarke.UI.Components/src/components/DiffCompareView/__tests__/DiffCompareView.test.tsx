...
describe("DiffCompareView", () => {
  ...
  describe("Side-by-Side Mode", () => {
    ...
    it("render_SideBySideMode_ShowsOriginalAndProposedPanes", () => {
      ...
      expect(
        screen.getByRole("region", { name: "Original text" }),
      ).toBeInTheDocument();
      expect(
        screen.getByRole("region", { name: "Proposed text" }),
      ).toBeInTheDocument();
    });
  ...
  describe("Inline Mode", () => {
    it("render_InlineMode_ShowsInlineDiffView", () => {
      ...
      expect(
        screen.getByRole("region", { name: "Inline diff view" }),
      ).toBeInTheDocument();
  ...
  describe("Action Buttons", () => {
    ...
    it("readOnly_True_HidesActionButtons", () => {
      ...
      expect(
        screen.queryByRole("button", { name: "Accept changes" }),
    ...
    it("editButton_OnEditProvided_ShowsEditButton", () => {
      ...
      expect(
        screen.getByRole("button", { name: "Edit proposed text" }),
      ).toBeInTheDocument();
    });
    ...
    it("editButton_OnEditNotProvided_HidesEditButton", () => {
      ...
      expect(
        screen.queryByRole("button", { name: "Edit proposed text" }),
      ).not.toBeInTheDocument();
    });
  });
  ...
  describe("Edit Mode", () => {
    it("editMode_ClickEdit_ShowsTextareaAndSaveCancel", async () => {
      ...
      expect(
        screen.getByRole("textbox", { name: "Edit proposed text" }),
      ).toBeInTheDocument();
      expect(
    ...
    it("editMode_ClickCancel_ExitsEditModeWithoutSaving", async () => {
      ...
      expect(
        screen.queryByRole("textbox", { name: "Edit proposed text" }),
      ).not.toBeInTheDocument();
  ...
  describe("Keyboard Shortcuts", () => {
    ...
    it("keyboardShortcut_ShowsHintText", () => {
      ...
      expect(
        screen.getByText("Ctrl+Enter: Accept | Esc: Reject"),
      ).toBeInTheDocument();
    });
  });
  ...
  describe("HTML Mode", () => {
    it("htmlMode_SideBySide_ShowsAnnotatedHtmlPanes", () => {
      ...
      expect(
        screen.getByRole("region", { name: "Original content" }),
      ).toBeInTheDocument();
      expect(
        screen.getByRole("region", { name: "Proposed content" }),
      ).toBeInTheDocument();
    });
    ...
    it("htmlMode_Inline_ShowsAnnotatedHtmlInline", () => {
      ...
      expect(
        screen.getByRole("region", { name: "Inline HTML diff view" }),
      ).toBeInTheDocument();
    });
  });
  ...
  describe("Edge Cases", () => {
    it("emptyContent_BothEmpty_RendersWithoutError", () => {
      ...
      expect(
        screen.getByRole("region", { name: "Diff comparison view" }),
      ).toBeInTheDocument();
    });
    ...
    it("ariaLabel_CustomAriaLabel_AppliedToRoot", () => {
      ...
      expect(
        screen.getByRole("region", { name: "Custom diff label" }),
      ).toBeInTheDocument();
    });
  });
});
