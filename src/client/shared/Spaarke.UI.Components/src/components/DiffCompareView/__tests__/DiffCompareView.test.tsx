...
describe('DiffCompareView', () => {
  ...
  describe('Side-by-Side Mode', () => {
    it('render_DefaultMode_ShowsSideBySideLabels', () => {
      renderWithProviders(<DiffCompareView {...defaultProps} onAccept={mockOnAccept} onReject={mockOnReject} />);
    ...
    it('render_SideBySideMode_ShowsOriginalAndProposedPanes', () => {
      renderWithProviders(
        <DiffCompareView {...defaultProps} mode="side-by-side" onAccept={mockOnAccept} onReject={mockOnReject} />
      );
    ...
    it('render_WithTitle_DisplaysTitle', () => {
      renderWithProviders(
        <DiffCompareView {...defaultProps} title="AI Revision" onAccept={mockOnAccept} onReject={mockOnReject} />
      );
  ...
  describe('Inline Mode', () => {
    it('render_InlineMode_ShowsInlineDiffView', () => {
      renderWithProviders(
        <DiffCompareView {...defaultProps} mode="inline" onAccept={mockOnAccept} onReject={mockOnReject} />
      );
  ...
  describe('Action Buttons', () => {
    ...
    it('readOnly_True_HidesActionButtons', () => {
      renderWithProviders(
        <DiffCompareView {...defaultProps} readOnly={true} onAccept={mockOnAccept} onReject={mockOnReject} />
      );
    ...
    it('editButton_OnEditProvided_ShowsEditButton', () => {
      renderWithProviders(
        <DiffCompareView {...defaultProps} onAccept={mockOnAccept} onReject={mockOnReject} onEdit={mockOnEdit} />
      );
  ...
  describe('Keyboard Shortcuts', () => {
    it('keyboardShortcut_CtrlEnter_CallsOnAccept', () => {
      const { container } = renderWithProviders(
        <DiffCompareView {...defaultProps} onAccept={mockOnAccept} onReject={mockOnReject} />
      );

      const rootRegion = screen.getByRole('region', {
        name: 'Diff comparison view',
      });
  ...
  describe('Edge Cases', () => {
    it('emptyContent_BothEmpty_RendersWithoutError', () => {
      renderWithProviders(
        <DiffCompareView originalText="" proposedText="" onAccept={mockOnAccept} onReject={mockOnReject} />
      );
