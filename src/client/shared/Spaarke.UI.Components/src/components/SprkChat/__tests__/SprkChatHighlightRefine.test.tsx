...
const TestWrapper: React.FC<{
  ...
  return (
    <div>
      ...
      <SprkChatHighlightRefine contentRef={contentRef} onRefine={onRefine} isRefining={isRefining} />
    </div>
  );
};
...
describe('SprkChatHighlightRefine', () => {
  ...
  describe('Rendering', () => {
    it('should render nothing when no text is selected', () => {
      renderWithProviders(<TestWrapper onRefine={mockOnRefine} />);
  ...
  describe('Refinement Flow', () => {
    ...
    it('should call onRefine with selected text and instruction on submit', async () => {
      ...
      expect(mockOnRefine).toHaveBeenCalledWith(expect.any(String), 'simplify');
    });
  ...
  describe('Refining State', () => {
    it('should show spinner when isRefining is true', async () => {
      renderWithProviders(<TestWrapper onRefine={mockOnRefine} isRefining={true} />);
