...
describe('SprkChatPredefinedPrompts', () => {
  const mockPrompts: IPredefinedPrompt[] = [
    ...
    },
    {
      ...
      prompt: 'Review this document for potential issues.',
    },
    {
      key: 'extract',
      label: 'Extract key terms',
      prompt: 'Extract the key terms and definitions.',
    },
  ];
  ...
  describe('Rendering', () => {
    it('should render all prompt buttons', () => {
      renderWithProviders(<SprkChatPredefinedPrompts prompts={mockPrompts} onSelect={mockOnSelect} />);
  ...
  describe('Disabled State', () => {
    it('should disable all prompt buttons when disabled is true', () => {
      renderWithProviders(<SprkChatPredefinedPrompts prompts={mockPrompts} onSelect={mockOnSelect} disabled={true} />);
    ...
    it('should enable all prompt buttons when disabled is false', () => {
      renderWithProviders(<SprkChatPredefinedPrompts prompts={mockPrompts} onSelect={mockOnSelect} disabled={false} />);
