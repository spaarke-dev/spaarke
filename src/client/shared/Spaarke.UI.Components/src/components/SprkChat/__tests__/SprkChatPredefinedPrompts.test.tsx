...
describe("SprkChatPredefinedPrompts", () => {
  ...
  describe("Rendering", () => {
    ...
    it("should render data-testid for each prompt", () => {
      ...
      expect(
        screen.getByTestId("predefined-prompt-summary"),
      ).toBeInTheDocument();
      expect(
        screen.getByTestId("predefined-prompt-review"),
      ).toBeInTheDocument();
      expect(
        screen.getByTestId("predefined-prompt-extract"),
      ).toBeInTheDocument();
    });
  });
  ...
  describe("Selection Behavior", () => {
    ...
    it("should call onSelect with the correct prompt for each button", async () => {
      ...
      expect(mockOnSelect).toHaveBeenCalledWith(
        "Review this document for potential issues.",
      );
    });
  });
