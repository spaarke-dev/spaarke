...
describe('SprkChatMessage', () => {
  ...
  describe('Timestamps', () => {
    it('should display timestamp for non-streaming messages', () => {
      renderWithProviders(<SprkChatMessage message={userMessage} isStreaming={false} />);
    ...
    it('should not display timestamp when streaming', () => {
      ...
      renderWithProviders(<SprkChatMessage message={streamingMsg} isStreaming={true} />);
  ...
  describe('Streaming Indicator', () => {
    it('should show thinking indicator when streaming with empty content', () => {
      ...
      renderWithProviders(<SprkChatMessage message={emptyStreamMsg} isStreaming={true} />);
    ...
    it('should not show thinking indicator when streaming with content', () => {
      ...
      renderWithProviders(<SprkChatMessage message={partialMsg} isStreaming={true} />);
    ...
    it('should not show thinking indicator when not streaming', () => {
      ...
      renderWithProviders(<SprkChatMessage message={emptyMsg} isStreaming={false} />);
  ...
  describe('Dark Mode Compliance', () => {
    it('should use semantic tokens (no hardcoded colors in rendered output)', () => {
      const { container } = renderWithProviders(<SprkChatMessage message={userMessage} />);
