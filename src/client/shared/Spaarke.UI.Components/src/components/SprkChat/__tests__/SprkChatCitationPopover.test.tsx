...
describe("SprkChatCitationPopover", () => {
  ...
  const fullCitation: ICitation = {
    ...
    page: 42,
    excerpt:
      "Employees must comply with all applicable regulations and standards.",
  ...
  it("Popover_HidesPageNumber_WhenNotProvided", async () => {
    ...
    renderWithProviders(<CitationMarker citation={minimalCitation} />);
  ...
  it("Popover_ShowsExcerpt_Truncated", async () => {
    ...
    renderWithProviders(<CitationMarker citation={longExcerptCitation} />);
  ...
  it("Popover_ShowsOpenSourceLink_WhenUrlProvided", async () => {
    ...
    await waitFor(() => {
      ...
      expect(link).toHaveAttribute(
        "href",
        "https://example.com/policy-handbook",
      );
  ...
  it("Dismiss_EscapeKey_ClosesPopover", async () => {
    ...
    await waitFor(() => {
      expect(
        screen.queryByTestId("citation-popover-1"),
