...
describe('SprkChatActionMenu', () => {
  ...
  describe('Keyboard Navigation', () => {
    ...
    it('should call onSelect with the correct action on Enter', async () => {
      ...
      expect(mockOnSelect).toHaveBeenCalledWith(expect.objectContaining({ id: 'run-playbook', label: 'Run Playbook' }));
    });
    ...
    it('should not call onSelect for disabled items on Enter', async () => {
      ...
      expect(mockOnSelect).toHaveBeenCalledWith(expect.objectContaining({ id: 'a2' }));
    });
  });
  ...
  describe('Imperative Handle', () => {
    ...
    it('should call onSelect when selectActive is invoked via ref', () => {
      ...
      expect(mockOnSelect).toHaveBeenCalledWith(expect.objectContaining({ id: 'run-playbook' }));
    });
  });
  ...
  describe('Edge Cases', () => {
    it('should handle a single action correctly', () => {
      const singleAction: IChatAction[] = [{ id: 'only-one', label: 'Only Action', category: 'actions' }];
    ...
    it('should handle actions without descriptions', () => {
      const noDescActions: IChatAction[] = [{ id: 'no-desc', label: 'No Description', category: 'search' }];
    ...
    it('should handle actions without shortcuts', () => {
      const noShortcutActions: IChatAction[] = [{ id: 'no-shortcut', label: 'No Shortcut', category: 'actions' }];
    ...
    it('should reset active index when filter changes', () => {
      const { rerender } = renderWithProviders(<SprkChatActionMenu {...defaultProps} filterText="" />);
