...
describe("SprkChatActionMenu", () => {
  ...
  describe("Rendering", () => {
    ...
    it("should not render the menu when isOpen is false", () => {
      ...
      expect(
        screen.queryByTestId("sprkchat-action-menu"),
    ...
    it("should render action items with descriptions", () => {
      ...
      expect(
        screen.getByText("Execute a predefined playbook"),
      ).toBeInTheDocument();
      expect(
        screen.getByText("Generate a summary of the current document"),
      ).toBeInTheDocument();
      expect(
        screen.getByText("Search across all documents"),
      ).toBeInTheDocument();
    });
    ...
    it("should render each action with a data-testid", () => {
      ...
      expect(
        screen.getByTestId("action-menu-item-run-playbook"),
      ).toBeInTheDocument();
      expect(
        screen.getByTestId("action-menu-item-summarize"),
      ).toBeInTheDocument();
      expect(
        screen.getByTestId("action-menu-item-search-docs"),
      ).toBeInTheDocument();
      expect(
        screen.getByTestId("action-menu-item-toggle-theme"),
      ).toBeInTheDocument();
    });
    ...
    it("should render category groups with aria-label matching category name", () => {
      ...
      expect(
        screen.getByRole("group", { name: "Playbooks" }),
      ).toBeInTheDocument();
      expect(
  ...
  describe("Filtering", () => {
    it("should show only actions matching filter text in label", () => {
      ...
      expect(
        screen.queryByTestId("action-menu-item-run-playbook"),
      ).not.toBeInTheDocument();
      expect(
        screen.queryByTestId("action-menu-item-search-docs"),
      ).not.toBeInTheDocument();
    });
    ...
    it("should match partial text across multiple categories", () => {
      ...
      expect(
        screen.getByTestId("action-menu-item-create-playbook"),
      ).toBeInTheDocument();
    });
  });
  ...
  describe("Accessibility", () => {
    ...
    it("should update aria-activedescendant when navigation changes", async () => {
      ...
      expect(menu.getAttribute("aria-activedescendant")).toBe(
        "action-menu-item-create-playbook",
      );
    });
    ...
    it("should have shortcut aria-label on shortcut badges", () => {
      ...
      expect(
        screen.getByLabelText("Keyboard shortcut: Ctrl+P"),
      ).toBeInTheDocument();
      expect(
        screen.getByLabelText("Keyboard shortcut: Ctrl+K"),
      ).toBeInTheDocument();
    });
  });
  ...
  describe("Theme Support", () => {
    ...
    themes.forEach(({ name, theme }) => {
      it(`should render without errors in ${name} theme`, () => {
        ...
        expect(
          container.querySelector('[data-testid="sprkchat-action-menu"]'),
        ).toBeInTheDocument();
      });
    });
  });
  ...
  describe("Imperative Handle", () => {
    it("should expose navigateDown via ref", () => {
      ...
      renderWithProviders(<SprkChatActionMenu ref={ref} {...defaultProps} />);
  ...
  describe("Edge Cases", () => {
    ...
    it("should handle actions without shortcuts", () => {
      ...
      expect(
        screen.queryByLabelText(/Keyboard shortcut/),
      ).not.toBeInTheDocument();
    });
