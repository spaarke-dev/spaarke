...
describe("GridView", () => {
  ...
  describe("Rendering", () => {
    ...
    it("should hide columns marked as hidden", () => {
      ...
      renderWithProviders(
        <GridView {...defaultProps} columns={columnsWithHidden} />,
      );
  ...
  describe("User Interactions", () => {
    it("should call onRecordClick when row is clicked", async () => {
      ...
      renderWithProviders(
        <GridView {...defaultProps} onRecordClick={onRecordClick} />,
      );
    ...
    it("should display selected rows", () => {
      renderWithProviders(
        <GridView {...defaultProps} selectedRecordIds={["1"]} />,
      );
  ...
  describe("Virtualization", () => {
    ...
    it("should not virtualize for small datasets", () => {
      renderWithProviders(
        <GridView {...defaultProps} enableVirtualization={true} />,
      );
