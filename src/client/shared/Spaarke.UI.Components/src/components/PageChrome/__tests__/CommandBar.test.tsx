...
describe('CommandBar', () => {
  ...
  describe('button states', () => {
    ...
    it('should enable Delete button when there is a selection', () => {
      renderWithProvider(<CommandBar {...defaultProps} selectedIds={['id-1', 'id-2']} canDelete />);
    ...
    it('should disable Delete button when canDelete is false', () => {
      renderWithProvider(<CommandBar {...defaultProps} selectedIds={['id-1']} canDelete={false} />);
  ...
  describe('event handlers', () => {
    ...
    it('should call onDelete with selectedIds when Delete button is clicked', () => {
      ...
      renderWithProvider(<CommandBar {...defaultProps} selectedIds={selectedIds} onDelete={onDelete} />);
  ...
  describe('search functionality', () => {
    it('should call onSearch when Enter is pressed in search box', () => {
      ...
      renderWithProvider(<CommandBar {...defaultProps} showSearch onSearch={onSearch} />);
    ...
    it('should use custom search placeholder', () => {
      renderWithProvider(<CommandBar {...defaultProps} showSearch searchPlaceholder="Find events..." />);
  ...
  describe('compact mode', () => {
    it('should apply compact styles when compact is true', () => {
      const { container } = renderWithProvider(<CommandBar {...defaultProps} compact />);
  ...
  describe('accessibility', () => {
    ...
    it('should have aria-keyshortcuts on buttons', () => {
      ...
      expect(screen.getByLabelText(/create new/i)).toHaveAttribute('aria-keyshortcuts', 'Control+N');
      expect(screen.getByLabelText(/delete selected/i)).toHaveAttribute('aria-keyshortcuts', 'Delete');
      expect(screen.getByLabelText(/refresh data/i)).toHaveAttribute('aria-keyshortcuts', 'F5');
    });
  });
});
