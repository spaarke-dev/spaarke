...
describe('ViewToolbar', () => {
  describe('rendering', () => {
    ...
    it('should render record count when provided', () => {
      ...
      expect(
        screen.getByText((_content, node) => node?.textContent === '(42)'),
      ).toBeInTheDocument();
    });
    ...
    it("should render count of 1 in viewName mode", () => {
      ...
      expect(
        screen.getByText((_content, node) => node?.textContent === '(1)'),
      ).toBeInTheDocument();
    });

    it('should format large record counts with locale', () => {
      renderWithProvider(<ViewToolbar viewName="Active Records" recordCount={1234567} />);
  ...
  describe('Edit filters button', () => {
    ...
    it('should call onEditFilters when button is clicked', () => {
      ...
      renderWithProvider(<ViewToolbar viewName="Test" showEditFilters onEditFilters={onEditFilters} />);
  ...
  describe('Edit columns button', () => {
    ...
    it('should call onEditColumns when button is clicked', () => {
      ...
      renderWithProvider(<ViewToolbar viewName="Test" showEditColumns onEditColumns={onEditColumns} />);
  ...
  describe('view name button', () => {
    it('should call onViewClick when view name button is clicked', () => {
      ...
      renderWithProvider(<ViewToolbar viewName="Active Records" onViewClick={onViewClick} />);
    ...
    it('should have aria-haspopup attribute', () => {
      ...
      expect(screen.getByLabelText('Change view')).toHaveAttribute('aria-haspopup', 'listbox');
    });
  });

  describe('compact mode', () => {
    it('should hide button labels in compact mode', () => {
      renderWithProvider(<ViewToolbar viewName="Test" showEditFilters showEditColumns compact />);
  ...
  describe('both buttons', () => {
    it('should render both buttons when both are enabled', () => {
      renderWithProvider(<ViewToolbar viewName="Test" showEditFilters showEditColumns />);
  ...
  describe('accessibility', () => {
    ...
    it('should have aria-label on toolbar', () => {
      ...
      expect(container.querySelector('[role="toolbar"]')).toHaveAttribute('aria-label', 'View toolbar');
    });
  });
});
