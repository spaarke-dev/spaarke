...
describe('CustomCommandFactory', () => {
  ...
  describe('Selection Validation', () => {
    it('should validate minimum selection', async () => {
      ...
      await expect(command.handler(context)).rejects.toThrow('Select at least 2 record(s)');
    });
    ...
    it('should validate maximum selection', async () => {
      ...
      await expect(command.handler(context)).rejects.toThrow('Select no more than 2 record(s)');
    });
