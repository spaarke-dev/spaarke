...
import { STANDALONE_CHAT_SESSION_KEY, STANDALONE_PLAYBOOK_KEY } from '../types/standalone-context';
...
export function StandaloneAiProvider({
  ...
  const subscribePaneEvents = useCallback((handler: ((event: AiPaneEvent) => void) | null) => {
