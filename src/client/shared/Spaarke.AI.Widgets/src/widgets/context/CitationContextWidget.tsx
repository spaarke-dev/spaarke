 ...
 */
const CitationContextWidget = forwardRef<ContextWidgetHighlightHandle, ContextWidgetProps<CitationData>>(
  function CitationContextWidget(props, ref) {
    ...
    return (
      <div ref={containerRef} style={{ height: '100%', overflow: 'hidden' }}>
        <CitationWidget data={data as CitationData} isLoading={isLoading} error={error} className={className} />
      </div>
    );
  }
);
