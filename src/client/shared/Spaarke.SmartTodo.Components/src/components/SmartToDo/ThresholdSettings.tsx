 ...
 * Cross-folder imports re-homed to package sources: the `DEFAULT_TODAY_THRESHOLD`
 * / `DEFAULT_TOMORROW_THRESHOLD` constants now come from the package's hoisted
 * `../../hooks/useKanbanColumns`; the `ITodoKanbanPreferences` type comes from
 * the package's `../../types/entities` (was the LW-local `useUserPreferences`).
 *
