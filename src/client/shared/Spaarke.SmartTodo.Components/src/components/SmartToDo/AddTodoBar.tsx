/**
 * AddTodoBar — Input bar for creating new manual to-do items.
 *
 * R5 FR-01 / task 002 — hoisted host-agnostic (verbatim; zero LW-local imports)
 * from `src/solutions/LegalWorkspace/src/components/SmartToDo/AddTodoBar.tsx`
...
export const AddTodoBar: React.FC<IAddTodoBarProps> = React.memo(({ onAdd, isAdding = false }) => {
  ...
  return (
    <div className={styles.bar} role="group" aria-label="Add to-do item">
      ...
      <div className={styles.inputWrapper}>
        ...
        />
        {validationError && (
          <span id="add-todo-error" role="alert" className={styles.validationMessage}>
            {validationError}
          </span>
        )}
      </div>
