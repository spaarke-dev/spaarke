...
- `infra/dataverse/sprk_playbookconsumer-rows.json` + `scripts/Seed-PlaybookConsumers.ps1` — the task-agenda Binding row (+ `chipTransitions` for capability-backed follow-ons).
