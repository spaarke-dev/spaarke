...
| 024 | E2 eval cases (dead-end + card gating) | 2 E2 | FR-10 | sonnet / high | FULL | ✅ | 021b, 023 | ✅ (FR-04/FR-06 guards already authored WITH their features per ADR-038: 021a service off-catalog drop, 021b client untyped/unbacked drop, 023 card open-tab gating, 013 AR4-003 dispatch — NOT duplicated. Added the one gate-owed guard: FR-04 no-dead-end CONTRACT fact `SuggestFollowupsAction_IsGroundedTypedTwoKindProposer_NoDeadEndFreeString` (8/8 R4 eval pass, net10) + FR-10 coverage map in Eval/README + register P2✅ + deferred D-024-01 for the typed-SSE endpoint test. Step 9.5 PASS. Test+docs only — no BFF source) |
