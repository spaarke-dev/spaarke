...
| 051 | UAT #1B numbering — option A (byte-identity guard; native authoring → R6) | 5 UAT remediation | ✅ | FULL | opus/xhigh | 050 | ❌ shared engine/projection |
...
| 055 | 422 anchor paraOffset fix + Open-Document modal + diagnostic (prong 1 recovery deferred) | 5 UAT remediation | ✅ | FULL | opus/xhigh | 050 | ❌ shared engine/ops/workspace |
