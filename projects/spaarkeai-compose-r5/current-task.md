...
| **Progress** | Phase 0 ✅; Phase 1 ✅ (010–014); **Phase 2: 020 ✅ (G1 origin routing).** NEXT: 021 (G2 clean-apply impl), 022 (G7 save split). |
...
| **Active task** | none in-flight. **020 DONE** — origin marker read on Load / resolve+persist on Save; client routes reopened authored → clean payload; 6/6 seam GREEN; gates clean; publish +0.05 MB. See notes/task-020-deviations.md. Next: 021 (G2 clean-apply — consumes 020's origin plumbing) or 022 (G7 save split). |
