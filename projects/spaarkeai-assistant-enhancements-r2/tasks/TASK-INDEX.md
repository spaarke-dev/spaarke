...
| 033 | Retention TTL spike + implement (FR-D10) | 4 D | 🔄 spike done (per-doc TTL feasible; awaiting owner go-ahead to implement) | 030 | **opus / xhigh** | FULL | none (persistence, after 030) |
