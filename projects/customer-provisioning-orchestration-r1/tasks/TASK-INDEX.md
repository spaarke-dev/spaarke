...
> **Last Updated**: 2026-08-19 (Wave G-2.5 -- tasks 127/128/129 authored, closing customer.bicep gaps flagged by tasks 123 + 126; Path 1 owner decision -- see notes/. Task 128b added same day during task 128's authoring, closing the DocIntel/AppInsights/LogAnalytics/Redis gap per E1/E2 escalation. **Task 128b COMPLETE** -- customer.bicep now wires all 3 remaining modules + spec.md/design.md/CLAUDE.md amended to v3.6 (Model 1/Model 2 Redis split). Task 128b's own escalation trigger 3 fires: task 129's 9-entry kv-secrets omission triage should be re-verified against 128b's landed state before 129 executes -- 3-4 entries (DocumentIntelligence-ApiKey, DocumentIntelligence-Endpoint, AppInsights-ConnectionString, Redis-ConnectionString for Model 2) are now potentially resolvable.)
