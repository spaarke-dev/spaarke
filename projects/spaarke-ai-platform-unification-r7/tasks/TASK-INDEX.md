...
> **Total tasks** (planned): ~80-110 across 10 waves
> **Tasks seeded** (Wave 1 only): 2 (001, 002)
> **Tasks pending generation**: ~78-108 (via `/task-create` per-wave as work advances)
...
|---|---|---|---|
| Wave 1 | AiCompletionNodeExecutor build (FR-12 to FR-15) | 🔲 not-started (2 of ~10 seeded) | 001, 002 generated; 003-010 to be generated by `/task-create` |
| Wave 2 | Dispatch refactor + enum rename (FR-07 to FR-10) | ⏸️ blocked on Wave 1 | 020-029 to be generated |
| Wave 3 | Typed config schemas (FR-16) | ⏸️ blocked on Wave 1 | 030-036 to be generated |
| Wave 4 | Schema cleanup + remove legacy direct-path (FR-03, FR-04, FR-11) | ⏸️ blocked on Wave 9 + Wave 2 | 040-047 to be generated |
| Wave 5 | Existing-playbook backfill (FR-19, FR-20) | ⏸️ blocked on Wave 2 | 050-056 to be generated |
| Wave 6 | Documentation deletion + updates (FR-28 to FR-31) | ⏸️ blocked on Wave 2 (partial) | 060-069 to be generated |
| Wave 7 | Skill rewrites (FR-32, FR-33) | ⏸️ blocked on Wave 2 | 070-075 to be generated |
| Wave 8 | Playbook Builder UI updates (FR-21 to FR-27) | ⏸️ blocked on Wave 2 + Wave 3 | 080-089d to be generated |
| Wave 9 | Consumer migration (FR-17, FR-18) | ⏸️ blocked on Wave 2 | 090-096 to be generated |
| Wave 10 | Wrap-up + R4 graduation gate close | ⏸️ blocked on all waves | 100, 101, 090-project-wrap-up to be generated |
...
### Generated (Wave 1 seeds)

- ✅ [`001-audit-aianalysis-aicompletion-patterns.poml`](001-audit-aianalysis-aicompletion-patterns.poml)
- ✅ [`002-scaffold-aicompletion-node-executor.poml`](002-scaffold-aicompletion-node-executor.poml)

### Pending generation

Waves 2-10 task POMLs (~78-108 files) to be generated by `/task-create` per-wave as work advances:

- **When to invoke `/task-create`**: at the start of each wave OR when a prior wave's prerequisites become satisfied
- **Pattern**: `/task-create projects/spaarke-ai-platform-unification-r7 --wave N` (or equivalent)
- **Alternative**: invoke `/task-create` once with the full project to generate all remaining task POMLs at once

This deferred generation is intentional — it keeps WBS planning lightweight and allows task content to incorporate learnings from completed waves.
