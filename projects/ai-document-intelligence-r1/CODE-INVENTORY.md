...
## 10. Dataverse Entities (Status Unknown)

These entities are referenced in code but need verification:

| Entity | Logical Name | Used By | Verified? |
|--------|--------------|---------|-----------|
| Analysis | sprk_analysis | AnalysisOrchestrationService | No |
| Analysis Action | sprk_analysisaction | ScopeResolverService | No |
| Analysis Skill | sprk_analysisskill | ScopeResolverService | No |
| Analysis Knowledge | sprk_analysisknowledge | ScopeResolverService | No |
| Knowledge Deployment | sprk_knowledgedeployment | ScopeResolverService | No |
| Analysis Tool | sprk_analysistool | ScopeResolverService | No |
| Analysis Playbook | sprk_analysisplaybook | AnalysisBuilder | No |
| Analysis Working Version | sprk_analysisworkingversion | WorkingDocumentService | No |
| Analysis Email Metadata | sprk_analysisemailmetadata | Export feature | No |
| Analysis Chat Message | sprk_analysischatmessage | AnalysisOrchestrationService | No |
...
**MAY need to create:**
- Dataverse entity definitions (if verification fails)
