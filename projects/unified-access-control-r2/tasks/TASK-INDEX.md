...
| 🔲 [open] 036 | Flag-gated swap + truncation + runbook | FR-20, NFR-02/03/04 | 032, **034**, 035 | — | ❌ | **opus** | **xhigh** |
...
| 🔲 [open] 054 | Root-set generalization (`sprk_servicerequest` 4th root) | FR-27 | 032,035,036 | — | ❌ | sonnet | high |
...
| # | Task | Deps | Safe |
|---|---|---|---|
| 🔲 [open] 090 | `/test-diet` · H-8a/H-8b closeout · lessons-learned · README → Complete | all | ❌ |
