...
| 🔲 [open] **028** | Service request: the missing 4th core accessible set | (task 009 escalation) | 009 | ❌ | sonnet | high | Model names 4 core types; `CallerPrincipal` carries 3. Completes the owner parity decision |
