...
| 🔲 [open] **024** | SPE Graph paging + `/revoke` status parity | M1,M2 | 016,017 | ❌ | sonnet | high | `container_not_cleared` currently gives FALSE assurance on a multi-page container |
