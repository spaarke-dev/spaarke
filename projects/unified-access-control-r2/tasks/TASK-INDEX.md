...
| 🔲 [open] **029** | External To Do read + create parity (matter + WA) | (task 009 asymmetry) | 009 | ❌ | sonnet | high | Task 009 widened PATCH but not list/create — **the write plane is now wider than the read plane**. Owner intent: parent flows from creation context |
