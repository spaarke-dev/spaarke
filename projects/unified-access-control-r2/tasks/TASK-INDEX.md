...
| 🔔 **021** | Provisioning stamping PATCH: wrong names + swallowed 400 | Critical (C4/C5) | 008 | ❌ | **opus** | **xhigh** | **ESCALATED 2026-08-24 at step 0** — the two `@odata.bind` nav-property names cannot be recovered from any available source. **Root cause found**: a stale schema doc, not a typo. Only 2 of the 3 are lookups; `sprk_containerid` is plain text. [`notes/task-021-provisioning-stamping.md`](../notes/task-021-provisioning-stamping.md) |
