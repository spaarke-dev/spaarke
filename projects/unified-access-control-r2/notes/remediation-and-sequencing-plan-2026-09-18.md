...
|---|---|---|
| **0 — bookkeeping** | **115** (§2 repair), then **109 / 111 / 112 / 114 / 116** authored via `/task-create` | Nothing here touches the evaluator. Removes nine wrong-instruction hazards before any execution. |
...
| **4 — owner-gated** | **107** (ADR-002 exception) · **110** (ISS-020) · **054** (ISS-003/#964) · **036** (034's A-vs-B) | Each waits on a named decision in §5, not on engineering. |
...
| **6 — wrap-up** | **090** | `/test-diet` + the defer/issue **disposition gate** — which now has 25 entries and must account for ISS-025. |
