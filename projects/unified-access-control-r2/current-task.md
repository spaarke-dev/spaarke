...
| Field | Value |
|---|---|
| **Task** | **100 — FR-33 expiry reminders (finish)** · `tasks/100-fr33-expiry-reminder-job.poml` · **PAUSED → RESUME NEXT** (implemented at `e7bd02189`; the review fixes in § Task 100 below — fix 7 DONE by 103, fix 8 now carries the owner's catch-up decision). **Must be live by 2026-11-10.** **103 ✅ COMPLETE 2026-09-14** (`a9c538c72` + `0f1414c37`) — full record `notes/task-103-scheduled-jobs-exactly-once.md`. **102 ✅ 2026-09-13.** |
