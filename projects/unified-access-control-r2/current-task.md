...
| Field | Value |
|---|---|
| **Task** | **103 — Scheduler lease + slot guard + `AddScheduledJob<TJob>` helper** · FULL · opus@high · `tasks/103-scheduled-jobs-exactly-once.poml` · **NOT STARTED**. Then **100** (finish; paused at `e7bd02189`, needs 103; must be live by **2026-11-10**). **102 ✅ COMPLETE 2026-09-13** — full record `notes/task-102-workload-placement-governance.md`. |
