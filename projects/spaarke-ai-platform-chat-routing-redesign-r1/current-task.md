...
> **Recovery**: READ "Quick Recovery" section FIRST. Tasks 112 + 113R + 115 + 111R + 117a + 116 + 114R + 117b + 114a ✅ shipped on `work/spaarke-ai-platform-chat-routing-redesign-r1`. Next active tasks: 114b (FE widget rework — now unblocked by the locked SSE contract), 114c (ADR; main session only because `.claude/` touch). 117 (telemetry, blocked-by 117b) now unblocked.
