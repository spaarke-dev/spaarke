...
| **1-F** | 020, 021 | 🔄 in-progress | 2026-06-22 | — | — | Pattern B name-resolve migrations: 020 BE (AppOnlyAnalysisService + ChatContextMappingService), 021 FE (useAiSummary + DocumentEmailWizard). 2 parallel agents. |
| **0-B** | 004 | 🔲 pending | — | — | — | |
