...
| R-6 | PDF.js + mammoth combined bundle exceeds 250 KB gzip | Medium | Medium | Lazy-load both; verify in NFR-12 task; consider alternative DOCX lib if mammoth too large (UQ-04) |
