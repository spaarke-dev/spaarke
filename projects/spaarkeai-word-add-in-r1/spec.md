...
> The ADR-012 and ADR-050 rows were identified at design time; the other four were raised and resolved during execution (each is also in project `CLAUDE.md` Decisions). All other listed ADRs apply without exception.
