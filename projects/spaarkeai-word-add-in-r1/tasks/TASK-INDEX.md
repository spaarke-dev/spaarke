...
| 036 | FR-15: Send Email via Outlook with document and record links — **done 2026-09-15** (`74a3d05fb`, merged `e6e38422e`): `displayNewMessageForm` (Mailbox 1.6, read mode); document link through the existing share-link route; record link through 027's URL builder; a failed mint opens nothing. **Word: hidden** (no mailbox in Word) — owner confirmation pending | ✅ | FULL | sonnet / high | P3-c | 026 |
