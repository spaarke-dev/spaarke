...
| 011 | Fix RB-T028-03/04/05/06 cluster — conditional registration root cause (HIGH × 4) | 1 | 🔄 PHASE 1d-PENDING-SECURITY-REVIEW 2026-06-01 (Phase 1a/1b/1c/1d.1/1d.2 ✅; 18 services migrated via Null-Object pattern per ADR-030; awaiting `dev@spaarke.com` approval on PR #318 comment `4596627823`) | 000, 001 | (sequential, after 010) | FULL | ✓ |
