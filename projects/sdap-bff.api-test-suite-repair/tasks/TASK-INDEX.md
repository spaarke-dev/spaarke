...
> **Total tasks**: 58 (+ wrap-up = 59 total POMLs)
> **Parallel-safe**: 53 of 58 (5 sequential gates only)
> **Total execution waves**: 13
...
| ID | Task | Status | Group | Parallel-safe | Rigor | Dependencies |
|---|---|---|---|---|---|---|
| 010 | Compile-fix batch 1 (Workspace, EmailWebhook, ExternalAccess, Email) | 🔲 | 1-A | ✅ Yes | FULL | none |
| 011 | Compile-fix batch 2 (Communications — 5 files) | 🔲 | 1-A | ✅ Yes | FULL | none |
| 012 | Compile-fix batch 3 (Ai/Tools, Ai/Sessions) | 🔲 | 1-A | ✅ Yes | FULL | none |
| 013 | Compile-fix batch 4 (Ai/Scope, Visualization, WorkingDocument, Jobs, Integration) | 🔲 | 1-A | ✅ Yes | FULL | none |
| 014 | Verify all 17 compile + capture runtime delta | 🔲 | 1-B | ❌ No (gate) | STANDARD | 010, 011, 012, 013 |
...
| ID | Task | Status | Group | Parallel-safe | Rigor | Dependencies |
|---|---|---|---|---|---|---|
| 024 | Spe.Integration.Tests classify failures + triage doc | 🔲 | 1-A | ✅ Yes | STANDARD | 002 |
...
| 0.2 | 004, 005 | 2 | Wave 0.1 complete | Depends on baseline + decisions |
