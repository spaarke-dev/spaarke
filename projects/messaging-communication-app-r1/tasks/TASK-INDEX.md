...
| 042 | Privacy / internal-only / privilege — BFF query-filter enforcement, point-forward | W4 | bff-api, communication, security | FR-08 | 040,005,002 | 050 | true | FULL | opus/xhigh | ✅ (Services/Communication/Access/ CommunicationAccessFilter — default-deny, fail-closed; visible = ¬internalOnly-to-external ∧ (private?hasGrant(point-forward):openMembership); privilege=metadata-only never gates/never AI [ADR-015]; owner-approved option-B contract MembershipResolver(anchor)∪overlayGrants; 16 neg/authz tests; 400 Comm pass; +0.3MB; **security gate PASS 0 Critical**. ⚠️ NEEDS overlay-grant table+provider [deny-all until then]; privilege-gating owner-confirm) |
