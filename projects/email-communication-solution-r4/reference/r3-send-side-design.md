> **⚠️ REFERENCE COPY — absorbed into email-communication-solution-r4 (2026-07-14).**
> This is a verbatim copy of the (never-executed) R3 design, preserved inside R4 so the unified project is **self-contained**. It is the **authoring detail for R4's send-side waves W2/W4/W6** (see `../design.md` §8.5, §9). The original project is retired at `projects/x-email-communication-solution-r3/`. Treat this as reference input, not an independent plan — the canonical design is `../design.md`.
...
> **Date**: 2026-06-05
> **Parent project**: email-communication-solution-r2 (server-side, completed 2026-04)
> **Driver document**: Communication Architecture Assessment 2026-06-05 (`docs/assessments/`)
