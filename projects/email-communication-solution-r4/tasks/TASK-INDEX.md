...
| 074 | Add-in save pane consumes Association Engine suggestions | W7 | office-addins | FR-25 | 072,012 | — | true | FULL | 🔄 SPLIT (owner 2026-07-15): **BFF suggestion capability** (evaluate-only engine path + suggestion endpoint, UI-agnostic) BUILT with the engine wave (Path C); **add-in save-pane UI + live-Outlook smoke test DEFERRED** to a future add-in-strategy effort ("don't hold up this project for add-ins"). |
