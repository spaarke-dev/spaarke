...
- **Two-Dataverse-stacks unification** (`ServiceClient` vs raw-HTTP, ~25–30 files, needs its own ADR) — deferred; filed as an Idea (FR-23). BFF workstream only consolidates the *boilerplate downcast within the app-only HTTP camp*.
