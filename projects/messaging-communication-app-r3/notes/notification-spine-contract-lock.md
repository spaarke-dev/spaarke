...
> **Date**: 2026-07-21 · **From**: `spaarke-notification-spine-r1` (task 025 / FR-19)
...
[`Services/Communication/CommunicationArrivedProducer.cs`](../../../../spaarke/src/server/api/Sprk.Bff.Api/Services/Communication/CommunicationArrivedProducer.cs)
...
Shipped type:
[`Services/Notifications/Envelopes/CommunicationEnvelope.cs`](../../../../spaarke/src/server/api/Sprk.Bff.Api/Services/Notifications/Envelopes/CommunicationEnvelope.cs)
(a `sealed record`, **9 properties**, guarded by a reflection test). `kind` is the closed enum
`NotificationKind` ([`NotificationKind.cs`](../../../../spaarke/src/server/api/Sprk.Bff.Api/Services/Notifications/Envelopes/NotificationKind.cs)),
...
[`SignalRDeliveryService.cs`](../../../../spaarke/src/server/api/Sprk.Bff.Api/Services/Notifications/SignalRDeliveryService.cs)).
...
**Client library** — [`@spaarke/notifications`](../../../../spaarke/src/client/shared/Spaarke.Notifications/README.md)
...
[`Api/Notifications/NotificationsEndpoints.cs`](../../../../spaarke/src/server/api/Sprk.Bff.Api/Api/Notifications/NotificationsEndpoints.cs)):
...
Authoritative API reference: the [`@spaarke/notifications` README](../../../../spaarke/src/client/shared/Spaarke.Notifications/README.md) "Contract lock" section. Questions → `spaarke-notification-spine-r1`.
