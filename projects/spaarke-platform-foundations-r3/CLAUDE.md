...
| ADR | Title | Relevance |
|---|---|---|
| **ADR-001** | BFF Minimal API + BackgroundService | BFF endpoints in Minimal API; where background work runs → [ADR-052](../../.claude/adr/ADR-052-workload-placement.md) (`Spaarke.Scheduling` is the in-BFF mechanism, ADR-036) |
