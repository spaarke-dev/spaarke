...
- Compute/read **quickXorHash** and persist to a new indexed `sprk_document.sprk_canonicalhash`. Also stamp the SPE **`sprk_canonicalhash` container column** for within-container SPE-native lookups.
