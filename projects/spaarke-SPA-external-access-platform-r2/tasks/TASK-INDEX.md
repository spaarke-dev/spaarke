...
| 070 | Polymorphic external grant-WRITE (BFF) — grant/revoke across Project/Matter/WorkAssignment + close-project lookup-name bug fix | P2b | 🔲 (code+tests+gates DONE 2026-08-10; deploy+live-write gate pending) | 028,020 | O/x | FULL | — (auth boundary write; own redeploy) |
| 071 | Polymorphic grant UI — TrackingFieldTrio host + AccessGrantModal across roots; adopt shared side-pane Advanced-Lookup (INavigationService.openLookup) | P2b | 🔲 | 070 | S/h | FULL | — (shared lib + PCF; solution import) |
