...
| DF-04 | 062/064 | `AnalysisContextBuilder.BuildContinuationPrompt` / `BuildContinuationPromptWithContext` appear caller-less after 062 removed `/continue` | Not named in 062's hand-off; left untouched to stay in scope. Dead-code sweep candidate. | No — future dead-code sweep |
