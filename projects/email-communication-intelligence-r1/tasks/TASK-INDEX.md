...
| 031 | Job B apply endpoint → `IActionSeam.UpdateRecordAsync` under OBO + `sprk_emailreviewlog` audit row | P3 | bff-api, communication | FR-10 | 030, 012 | P3 | **false** (shared endpoints) | FULL | opus/high | 🔲 |
