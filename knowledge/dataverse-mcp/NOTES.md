...
>
> The curated samples and `docs/` snapshots are in place. The project-specific commentary below is a structural placeholder, not annotated knowledge. Every section has a `_TODO_` marker; please replace with real guidance from Spaarke's experience. — curator, 2026-05-14

# NOTES — `dataverse-mcp`

## 1. The three flavors of Dataverse-as-MCP
...
## 3. Business Skills authoring conventions
...
## 5. Metering for non-Copilot-Studio consumers
...
## 6. Spaarke's migration pattern — structured playbook tables → Business Skills + App MCP
...
## 7. Operational gotchas observed during curation
