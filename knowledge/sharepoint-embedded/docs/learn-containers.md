...
fetched: 2026-05-14
note: Original URL returned 404. Captured equivalent app-architecture page that documents container, container type, and owning-application concepts, plus the containertypes creation page (see learn-containertypes.md).
