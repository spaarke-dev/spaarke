# ADR-032: BFF Null-Object Kill-Switch Pattern (Concise)
...
> **Note (2026-06-02)**: Originally drafted on master as ADR-030. Renumbered to ADR-032 during R4 merge to resolve number collision with R4's ADR-030 (PaneEventBus) + ADR-031 (Stage Lifecycle). See [`INDEX.md`](INDEX.md).
