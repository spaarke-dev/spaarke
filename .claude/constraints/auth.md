...
- ❌ **MUST NOT** call `.WithClientSecret(...)` for any client authenticating as the BFF identity. Transitional exception **E-3** covers the existing sites during `spaarke-auth-v4-dataverse-MI`; it does **not** license new ones.
