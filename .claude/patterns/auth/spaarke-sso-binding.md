...
What IS still canonical in this file: §"Required MSAL Configuration" (INV-1..INV-7) and §"Bundling Reality (CRITICAL)" (INV-8) — these remain canonical and are preserved by v2 literal lift. Cascade and strategy details are pre-v2.
═══════════════════════════════════════════════════════════════════════════
---
