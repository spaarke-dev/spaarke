...
| [record-header-composition.md](record-header-composition.md) | Authoring a new per-entity Record Header PCF (`ProjectHeaderPcf`, `InvoiceHeaderPcf`, etc.) OR consuming `@spaarke/ui-components` header primitives. Includes the mandatory bundle-optimization triad (`featureconfig.json` + `webpack.config.js` + deep-path imports). | 2026-07-03 | Current |
